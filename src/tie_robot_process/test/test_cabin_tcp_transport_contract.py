...
class CabinTcpTransportContractTest(unittest.TestCase):
    ...
    def test_driver_layer_does_not_own_heartbeat_polling_runtime_path(self):
        ...
        self.assertNotIn("CabinProtocol::buildHeartbeatFrame", driver)
        self.assertNotIn("CabinProtocol::decodeHeartbeatState", driver)
