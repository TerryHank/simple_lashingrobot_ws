...
from tie_robot_vision.perception import workspace_s2  # noqa: E402
...
def read_workspace_quad_pixels() -> list[list[int]]:
    ...
    fallback_path = REPO_ROOT / "src" / "tie_robot_vision" / "data" / "manual_workspace_quad.json"
...
<body>
  ...
  <main>
    ...
    <div class="runtime-note">
      ...
      <code>src/tie_robot_vision/tools/build_current_visual_recognition_flow_page.py</code>。
