#include "tie_robot_vision/perception/scepter_world_coord_processor.hpp"
...
bool ScepterWorldCoordProcessor::convertDepthToPointCloud(
    tie_robot_vision::ConvertDepthToPointCloud::Request& req,
    tie_robot_vision::ConvertDepthToPointCloud::Response& res)
{
    if (!has_depth_info_)
    {
