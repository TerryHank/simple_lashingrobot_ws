...
POINTAI_SCRIPT_PATH = WORKSPACE_ROOT / "tie_robot_vision" / "scripts" / "pointai_node.py"
LEGACY_POINTAI_SCRIPT_PATH = WORKSPACE_ROOT / "tie_robot_vision" / "scripts" / "pointAI.py"
...
LASHING_CONFIG_PATH = WORKSPACE_ROOT / "tie_robot_vision" / "data" / "lashing_config.json"
...
class PointAIScanOnlyPrFrpgTest(unittest.TestCase):
    def test_pointai_script_is_only_a_thin_ros_entrypoint(self):
        ...
        self.assertIn("from tie_robot_vision.pointai.node import ImageProcessor, main", pointai_text)
    ...
    def test_manual_workspace_s2_static_helpers_accept_runtime_arguments(self):
        from tie_robot_vision.pointai import manual_workspace_s2
        from tie_robot_vision.pointai.processor import bind_image_processor_methods
    ...
    def test_raw_camera_bind_point_tf_uses_scepter_depth_frame_and_meters(self):
        import rospy
        from tie_robot_vision.msg import PointCoords, PointsArray
        from tie_robot_vision.pointai import bind_point_tf
    ...
    def test_result_workspace_overlay_prefers_map_polygon_contour_for_display(self):
        from tie_robot_vision.pointai import rendering
        from tie_robot_vision.pointai.constants import PROCESS_IMAGE_MODE_DEFAULT
    ...
    def test_world_workspace_polygon_mask_covers_inside_area(self):
        from tie_robot_vision.pointai import workspace_masks
    ...
    def test_confirmed_workspace_display_mask_uses_map_frame_not_camera_frame(self):
        from tie_robot_vision.pointai import workspace_masks
        from tie_robot_vision.pointai import world_coord
    ...
    def test_live_visible_area_overlay_draws_gray_boundary_from_confirmed_workspace_mask(self):
        from tie_robot_vision.pointai.live_visible_area_overlay import (
    ...
    def test_execution_refine_result_label_shows_absolute_tcp_jaw_coordinate(self):
        from tie_robot_vision.pointai import rendering
        from tie_robot_vision.pointai.constants import PROCESS_IMAGE_MODE_EXECUTION_REFINE
    ...
    def test_result_display_label_rounds_camera_coordinates_to_integer_mm(self):
        from tie_robot_vision.pointai import rendering
        from tie_robot_vision.pointai.constants import (
    ...
    def test_tcp_display_helpers_expose_only_camera_to_gripper_frame_transform(self):
        import inspect
        from tie_robot_vision.pointai import tcp_display
    ...
    def test_tcp_display_returns_gripper_frame_coordinates_without_extra_axis_mapping(self):
        from tie_robot_vision.pointai.tcp_display import camera_coord_to_tcp_jaw_coord
    ...
    def test_tcp_display_vectorized_channels_match_scalar_coordinate_conversion(self):
        from tie_robot_vision.pointai.tcp_display import (
    ...
    def test_scan_linear_compensation_is_applied_to_raw_world_channels_once(self):
        from tie_robot_vision.pointai import manual_workspace_s2, world_coord
    ...
    def test_execution_refine_outputs_are_ordered_as_tcp_snake_rows_from_upper_right_origin(self):
        from tie_robot_vision.pointai import matrix_selection
        from tie_robot_vision.pointai.constants import PROCESS_IMAGE_MODE_EXECUTION_REFINE
    ...
    def test_workspace_s2_refines_global_line_positions_to_local_response_peaks(self):
        from tie_robot_vision.perception import workspace_s2
    ...
    def test_scan_linear_compensation_callback_accepts_translation_offsets(self):
        from tie_robot_vision.pointai import runtime_config
