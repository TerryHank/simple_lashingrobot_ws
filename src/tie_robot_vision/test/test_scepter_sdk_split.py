...
PACKAGE_DIR = WORKSPACE_SRC / "tie_robot_vision"
...
class ScepterSdkSplitTest(unittest.TestCase):
    ...
    def test_camera_header_no_longer_exposes_algorithm_members(self):
        content = (
            PACKAGE_DIR / "include" / "tie_robot_vision" / "camera" / "scepter_manager.hpp"
    ...
    def test_visual_consumers_do_not_apply_camera_info_distortion(self):
        ...
        pointai_image_buffers = (
            PACKAGE_DIR / "src" / "tie_robot_vision" / "pointai" / "image_buffers.py"
        ).read_text(encoding="utf-8")
