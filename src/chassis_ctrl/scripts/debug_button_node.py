...
BUTTON_CONFIG = {
    ...
    8: {'name': '视觉识别调试', 'topic': '/web/pointAI/process_image', 'type': 'std_msgs/Float32'},
    ...
    19: {'name': '设置高度阈值', 'topic': '/web/pointAI/set_height_threshold', 'type': 'std_msgs/Float32'},
    ...
    22: {'name': '设置TF平移标定', 'topic': '/web/pointAI/set_offset', 'type': 'geometry_msgs/Pose'},
