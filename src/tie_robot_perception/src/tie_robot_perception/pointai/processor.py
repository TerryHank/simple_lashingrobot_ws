...
def bind_image_processor_methods(cls):
    ...
    cls.get_tcp_occlusion_pixel_mask = workspace_masks.get_tcp_occlusion_pixel_mask
    cls.should_apply_tcp_occlusion_mask = workspace_masks.should_apply_tcp_occlusion_mask
