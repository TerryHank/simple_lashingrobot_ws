...
const optionLabels = new Map(IMAGE_TOPIC_OPTIONS.map((option) => [option.id, option.label]));
...
assert.equal(optionLabels.get(TOPICS.algorithm.executionRefineBaseImage), "执行视觉底图");
