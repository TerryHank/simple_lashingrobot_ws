...
class WorkspacePickerWebTest(unittest.TestCase):
    ...
    def test_toolbar_uses_theme_toggle_without_system_control_panel(self):
        ...
        self.assertNotIn("scanSurfaceDpCompletedSurfaceImage", image_topic_catalog)
    ...
    def test_status_capsule_tracks_only_connection_and_hardware(self):
        ...
        self.assertIn('chassis: level === "success" ? "stopCabinSubsystem" : level === "error" ? "restartCabinSubsystem" : "startCabinSubsystem"', ui_controller)
        self.assertIn('moduan: level === "success" ? "stopModuanSubsystem" : level === "error" ? "restartModuanSubsystem" : "startModuanSubsystem"', ui_controller)
        ...
        self.assertIn('chassis: level === "success" ? "关闭" : level === "error" ? "重启" : "启动"', ui_controller)
    ...
    def test_visual_recognition_uses_scan_action_and_result_image_topic(self):
        ...
        self.assertNotIn("scanSurfaceDpCompletedSurfaceImage", topic_registry)
        self.assertNotIn("/perception/lashing/scan_surface_dp_completed_surface_image", topic_registry)
        ...
        self.assertIn("bind_group_point_count:", task_action_controller)
        self.assertIn("normalizeAdaptiveBindGrouping(this.getAdaptiveBindGrouping?.()) ? 0 : 4", task_action_controller)
    ...
    def test_ir_image_keeps_tcp_overlay_and_does_not_draw_live_workspace_in_frontend(self):
        ...
        self.assertNotIn("onWorkspaceRangePoints", app_logic)
        self.assertNotIn("setRealtimeWorkspaceRangeMessage", app_logic)
        ...
        self.assertNotIn("projectRealtimeWorkspaceRangeToImage", scene_view)
        self.assertNotIn("workspaceRangeGroup", scene_view)
        ...
        self.assertNotIn("workspaceQuadCameraPoints", topic_registry)
        self.assertNotIn("algorithm.workspaceQuadCameraPoints", ros_connection_controller)
