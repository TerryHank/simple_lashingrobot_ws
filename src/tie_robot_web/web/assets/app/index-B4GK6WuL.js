 ...
 */var qa;function On(){return qa||(qa=1,function(i,e){(function(t){var n=Object.hasOwnProperty,r=Array.isArray?Array.isArray:function(w){return Object.prototype.toString.call(w)==="[object Array]"},s=10,o=typeof process=="object"&&typeof process.nextTick=="function",a=typeof Symbol=="function",l=typeof Reflect=="object",c=typeof setImmediate=="function",u=c?setImmediate:setTimeout,h=a?l&&typeof Reflect.ownKeys=="function"?Reflect.ownKeys:function(v){var w=Object.getOwnPropertyNames(v);return w.push.apply(w,Object.getOwnPropertySymbols(v)),w}:Object.keys;function d(){this._events={},this._conf&&f.call(this,this._conf)}function f(v){v&&(this._conf=v,v.delimiter&&(this.delimiter=v.delimiter),v.maxListeners!==t&&(this._maxListeners=v.maxListeners),v.wildcard&&(this.wildcard=v.wildcard),v.newListener&&(this._newListener=v.newListener),v.removeListener&&(this._removeListener=v.removeListener),v.verboseMemoryLeak&&(this.verboseMemoryLeak=v.verboseMemoryLeak),v.ignoreErrors&&(this.ignoreErrors=v.ignoreErrors),this.wildcard&&(this.listenerTree={}))}function g(v,w){var U="(node) warning: possible EventEmitter memory leak detected. "+v+" listeners added. Use emitter.setMaxListeners() to increase limit.";if(this.verboseMemoryLeak&&(U+=" Event name: "+w+"."),typeof process<"u"&&process.emitWarning){var N=new Error(U);N.name="MaxListenersExceededWarning",N.emitter=this,N.count=v,process.emitWarning(N)}else console.error(U),console.trace&&console.trace()}var x=function(v,w,U){var N=arguments.length;switch(N){case 0:return[];case 1:return[v];case 2:return[v,w];case 3:return[v,w,U];default:for(var V=new Array(N);N--;)V[N]=arguments[N];return V}};function m(v,w){for(var U={},N,V=v.length,K=0,I=0;I<V;I++)N=v[I],U[N]=I<K?w[I]:t;return U}function p(v,w,U){this._emitter=v,this._target=w,this._listeners={},this._listenersCount=0;var N,V;if((U.on||U.off)&&(N=U.on,V=U.off),w.addEventListener?(N=w.addEventListener,V=w.removeEventListener):w.addListener?(N=w.addListener,V=w.removeListener):w.on&&(N=w.on,V=w.off),!N&&!V)throw Error("target does not implement any known event API");if(typeof N!="function")throw TypeError("on method must be a function");if(typeof V!="function")throw TypeError("off method must be a function");this._on=N,this._off=V;var K=v._observers;K?K.push(this):v._observers=[this]}Object.assign(p.prototype,{subscribe:function(v,w,U){var N=this,V=this._target,K=this._emitter,I=this._listeners,k=function(){var j=x.apply(null,arguments),q={data:j,name:w,original:v};if(U){var le=U.call(V,q);le!==!1&&K.emit.apply(K,[q.name].concat(j));return}K.emit.apply(K,[w].concat(j))};if(I[v])throw Error("Event '"+v+"' is already listening");this._listenersCount++,K._newListener&&K._removeListener&&!N._onNewListener?(this._onNewListener=function(j){j===w&&I[v]===null&&(I[v]=k,N._on.call(V,v,k))},K.on("newListener",this._onNewListener),this._onRemoveListener=function(j){j===w&&!K.hasListeners(j)&&I[v]&&(I[v]=null,N._off.call(V,v,k))},I[v]=null,K.on("removeListener",this._onRemoveListener)):(I[v]=k,N._on.call(V,v,k))},unsubscribe:function(v){var w=this,U=this._listeners,N=this._emitter,V,K,I=this._off,k=this._target,j;if(v&&typeof v!="string")throw TypeError("event must be a string");function q(){w._onNewListener&&(N.off("newListener",w._onNewListener),N.off("removeListener",w._onRemoveListener),w._onNewListener=null,w._onRemoveListener=null);var le=X.call(N,w);N._observers.splice(le,1)}if(v){if(V=U[v],!V)return;I.call(k,v,V),delete U[v],--this._listenersCount||q()}else{for(K=h(U),j=K.length;j-- >0;)v=K[j],I.call(k,v,U[v]);this._listeners={},this._listenersCount=0,q()}}});function T(v,w,U,N){var V=Object.assign({},w);if(!v)return V;if(typeof v!="object")throw TypeError("options must be an object");var K=Object.keys(v),I=K.length,k,j,q;function le(ge){throw Error('Invalid "'+k+'" option value'+(ge?". Reason: "+ge:""))}for(var ve=0;ve<I;ve++){if(k=K[ve],!n.call(w,k))throw Error('Unknown "'+k+'" option');j=v[k],j!==t&&(q=U[k],V[k]=q?q(j,le):j)}return V}function S(v,w){return(typeof v!="function"||!v.hasOwnProperty("prototype"))&&w("value must be a constructor"),v}function A(v){var w="value must be type of "+v.join("|"),U=v.length,N=v[0],V=v[1];return U===1?function(K,I){if(typeof K===N)return K;I(w)}:U===2?function(K,I){var k=typeof K;if(k===N||k===V)return K;I(w)}:function(K,I){for(var k=typeof K,j=U;j-- >0;)if(k===v[j])return K;I(w)}}var B=A(["function"]),D=A(["object","function"]);function P(v,w,U){var N,V,K=0,I,k=new v(function(j,q,le){U=T(U,{timeout:0,overload:!1},{timeout:function(xe,Te){return xe*=1,(typeof xe!="number"||xe<0||!Number.isFinite(xe))&&Te("timeout must be a positive number"),xe}}),N=!U.overload&&typeof v.prototype.cancel=="function"&&typeof le=="function";function ve(){V&&(V=null),K&&(clearTimeout(K),K=0)}var ge=function(xe){ve(),j(xe)},L=function(xe){ve(),q(xe)};N?w(ge,L,le):(V=[function(xe){L(xe||Error("canceled"))}],w(ge,L,function(xe){if(I)throw Error("Unable to subscribe on cancel event asynchronously");if(typeof xe!="function")throw TypeError("onCancel callback must be a function");V.push(xe)}),I=!0),U.timeout>0&&(K=setTimeout(function(){var xe=Error("timeout");xe.code="ETIMEDOUT",K=0,k.cancel(xe),q(xe)},U.timeout))});return N||(k.cancel=function(j){if(V){for(var q=V.length,le=1;le<q;le++)V[le](j);V[0](j),V=null}}),k}function X(v){var w=this._observers;if(!w)return-1;for(var U=w.length,N=0;N<U;N++)if(w[N]._target===v)return N;return-1}function E(v,w,U,N,V){if(!U)return null;if(N===0){var K=typeof w;if(K==="string"){var I,k,j=0,q=0,le=this.delimiter,ve=le.length;if((k=w.indexOf(le))!==-1){I=new Array(5);do I[j++]=w.slice(q,k),q=k+ve;while((k=w.indexOf(le,q))!==-1);I[j++]=w.slice(q),w=I,V=j}else w=[w],V=1}else K==="object"?V=w.length:(w=[w],V=1)}var ge=null,L,xe,Te,Xe,Me,Be=w[N],Ie=w[N+1],Ae,Ve;if(N===V)U._listeners&&(typeof U._listeners=="function"?(v&&v.push(U._listeners),ge=[U]):(v&&v.push.apply(v,U._listeners),ge=[U]));else if(Be==="*"){for(Ae=h(U),k=Ae.length;k-- >0;)L=Ae[k],L!=="_listeners"&&(Ve=E(v,w,U[L],N+1,V),Ve&&(ge?ge.push.apply(ge,Ve):ge=Ve));return ge}else if(Be==="**"){for(Me=N+1===V||N+2===V&&Ie==="*",Me&&U._listeners&&(ge=E(v,w,U,V,V)),Ae=h(U),k=Ae.length;k-- >0;)L=Ae[k],L!=="_listeners"&&(L==="*"||L==="**"?(U[L]._listeners&&!Me&&(Ve=E(v,w,U[L],V,V),Ve&&(ge?ge.push.apply(ge,Ve):ge=Ve)),Ve=E(v,w,U[L],N,V)):L===Ie?Ve=E(v,w,U[L],N+2,V):Ve=E(v,w,U[L],N,V),Ve&&(ge?ge.push.apply(ge,Ve):ge=Ve));return ge}else U[Be]&&(ge=E(v,w,U[Be],N+1,V));if(xe=U["*"],xe&&E(v,w,xe,N+1,V),Te=U["**"],Te)if(N<V)for(Te._listeners&&E(v,w,Te,V,V),Ae=h(Te),k=Ae.length;k-- >0;)L=Ae[k],L!=="_listeners"&&(L===Ie?E(v,w,Te[L],N+2,V):L===Be?E(v,w,Te[L],N+1,V):(Xe={},Xe[L]=Te[L],E(v,w,{"**":Xe},N+1,V)));else Te._listeners?E(v,w,Te,V,V):Te["*"]&&Te["*"]._listeners&&E(v,w,Te["*"],V,V);return ge}function M(v,w,U){var N=0,V=0,K,I=this.delimiter,k=I.length,j;if(typeof v=="string")if((K=v.indexOf(I))!==-1){j=new Array(5);do j[N++]=v.slice(V,K),V=K+k;while((K=v.indexOf(I,V))!==-1);j[N++]=v.slice(V)}else j=[v],N=1;else j=v,N=v.length;if(N>1){for(K=0;K+1<N;K++)if(j[K]==="**"&&j[K+1]==="**")return}var q=this.listenerTree,le;for(K=0;K<N;K++)if(le=j[K],q=q[le]||(q[le]={}),K===N-1)return q._listeners?(typeof q._listeners=="function"&&(q._listeners=[q._listeners]),U?q._listeners.unshift(w):q._listeners.push(w),!q._listeners.warned&&this._maxListeners>0&&q._listeners.length>this._maxListeners&&(q._listeners.warned=!0,g.call(this,q._listeners.length,le))):q._listeners=w,!0;return!0}function C(v,w,U,N){for(var V=h(v),K=V.length,I,k,j,q=v._listeners,le;K-- >0;)k=V[K],I=v[k],k==="_listeners"?j=U:j=U?U.concat(k):[k],le=N||typeof k=="symbol",q&&w.push(le?j:j.join(this.delimiter)),typeof I=="object"&&C.call(this,I,w,j,le);return w}function H(v){for(var w=h(v),U=w.length,N,V,K;U-- >0;)V=w[U],N=v[V],N&&(K=!0,V!=="_listeners"&&!H(N)&&delete v[V]);return K}function O(v,w,U){this.emitter=v,this.event=w,this.listener=U}O.prototype.off=function(){return this.emitter.off(this.event,this.listener),this};function $(v,w,U){if(U===!0)V=!0;else if(U===!1)N=!0;else{if(!U||typeof U!="object")throw TypeError("options should be an object or true");var N=U.async,V=U.promisify,K=U.nextTick,I=U.objectify}if(N||K||V){var k=w,j=w._origin||w;if(K&&!o)throw Error("process.nextTick is not supported");V===t&&(V=w.constructor.name==="AsyncFunction"),w=function(){var q=arguments,le=this,ve=this.event;return V?K?Promise.resolve():new Promise(function(ge){u(ge)}).then(function(){return le.event=ve,k.apply(le,q)}):(K?process.nextTick:u)(function(){le.event=ve,k.apply(le,q)})},w._async=!0,w._origin=j}return[w,I?new O(this,v,w):this]}function z(v){this._events={},this._newListener=!1,this._removeListener=!1,this.verboseMemoryLeak=!1,f.call(this,v)}z.EventEmitter2=z,z.prototype.listenTo=function(v,w,U){if(typeof v!="object")throw TypeError("target musts be an object");var N=this;U=T(U,{on:t,off:t,reducers:t},{on:B,off:B,reducers:D});function V(K){if(typeof K!="object")throw TypeError("events must be an object");var I=U.reducers,k=X.call(N,v),j;k===-1?j=new p(N,v,U):j=N._observers[k];for(var q=h(K),le=q.length,ve,ge=typeof I=="function",L=0;L<le;L++)ve=q[L],j.subscribe(ve,K[ve]||ve,ge?I:I&&I[ve])}return r(w)?V(m(w)):V(typeof w=="string"?m(w.split(/\s+/)):w),this},z.prototype.stopListeningTo=function(v,w){var U=this._observers;if(!U)return!1;var N=U.length,V,K=!1;if(v&&typeof v!="object")throw TypeError("target should be an object");for(;N-- >0;)V=U[N],(!v||V._target===v)&&(V.unsubscribe(w),K=!0);return K},z.prototype.delimiter=".",z.prototype.setMaxListeners=function(v){v!==t&&(this._maxListeners=v,this._conf||(this._conf={}),this._conf.maxListeners=v)},z.prototype.getMaxListeners=function(){return this._maxListeners},z.prototype.event="",z.prototype.once=function(v,w,U){return this._once(v,w,!1,U)},z.prototype.prependOnceListener=function(v,w,U){return this._once(v,w,!0,U)},z.prototype._once=function(v,w,U,N){return this._many(v,1,w,U,N)},z.prototype.many=function(v,w,U,N){return this._many(v,w,U,!1,N)},z.prototype.prependMany=function(v,w,U,N){return this._many(v,w,U,!0,N)},z.prototype._many=function(v,w,U,N,V){var K=this;if(typeof U!="function")throw new Error("many only accepts instances of Function");function I(){return--w===0&&K.off(v,I),U.apply(this,arguments)}return I._origin=U,this._on(v,I,N,V)},z.prototype.emit=function(){if(!this._events&&!this._all)return!1;this._events||d.call(this);var v=arguments[0],w,U=this.wildcard,N,V,K,I,k;if(v==="newListener"&&!this._newListener&&!this._events.newListener)return!1;if(U&&(w=v,v!=="newListener"&&v!=="removeListener"&&typeof v=="object")){if(V=v.length,a){for(K=0;K<V;K++)if(typeof v[K]=="symbol"){k=!0;break}}k||(v=v.join(this.delimiter))}var j=arguments.length,q;if(this._all&&this._all.length)for(q=this._all.slice(),K=0,V=q.length;K<V;K++)switch(this.event=v,j){case 1:q[K].call(this,v);break;case 2:q[K].call(this,v,arguments[1]);break;case 3:q[K].call(this,v,arguments[1],arguments[2]);break;default:q[K].apply(this,arguments)}if(U)q=[],E.call(this,q,w,this.listenerTree,0,V);else if(q=this._events[v],typeof q=="function"){switch(this.event=v,j){case 1:q.call(this);break;case 2:q.call(this,arguments[1]);break;case 3:q.call(this,arguments[1],arguments[2]);break;default:for(N=new Array(j-1),I=1;I<j;I++)N[I-1]=arguments[I];q.apply(this,N)}return!0}else q&&(q=q.slice());if(q&&q.length){if(j>3)for(N=new Array(j-1),I=1;I<j;I++)N[I-1]=arguments[I];for(K=0,V=q.length;K<V;K++)switch(this.event=v,j){case 1:q[K].call(this);break;case 2:q[K].call(this,arguments[1]);break;case 3:q[K].call(this,arguments[1],arguments[2]);break;default:q[K].apply(this,N)}return!0}else if(!this.ignoreErrors&&!this._all&&v==="error")throw arguments[1]instanceof Error?arguments[1]:new Error("Uncaught, unspecified 'error' event.");return!!this._all},z.prototype.emitAsync=function(){if(!this._events&&!this._all)return!1;this._events||d.call(this);var v=arguments[0],w=this.wildcard,U,N,V,K,I,k;if(v==="newListener"&&!this._newListener&&!this._events.newListener)return Promise.resolve([!1]);if(w&&(U=v,v!=="newListener"&&v!=="removeListener"&&typeof v=="object")){if(K=v.length,a){for(I=0;I<K;I++)if(typeof v[I]=="symbol"){N=!0;break}}N||(v=v.join(this.delimiter))}var j=[],q=arguments.length,le;if(this._all)for(I=0,K=this._all.length;I<K;I++)switch(this.event=v,q){case 1:j.push(this._all[I].call(this,v));break;case 2:j.push(this._all[I].call(this,v,arguments[1]));break;case 3:j.push(this._all[I].call(this,v,arguments[1],arguments[2]));break;default:j.push(this._all[I].apply(this,arguments))}if(w?(le=[],E.call(this,le,U,this.listenerTree,0)):le=this._events[v],typeof le=="function")switch(this.event=v,q){case 1:j.push(le.call(this));break;case 2:j.push(le.call(this,arguments[1]));break;case 3:j.push(le.call(this,arguments[1],arguments[2]));break;default:for(V=new Array(q-1),k=1;k<q;k++)V[k-1]=arguments[k];j.push(le.apply(this,V))}else if(le&&le.length){if(le=le.slice(),q>3)for(V=new Array(q-1),k=1;k<q;k++)V[k-1]=arguments[k];for(I=0,K=le.length;I<K;I++)switch(this.event=v,q){case 1:j.push(le[I].call(this));break;case 2:j.push(le[I].call(this,arguments[1]));break;case 3:j.push(le[I].call(this,arguments[1],arguments[2]));break;default:j.push(le[I].apply(this,V))}}else if(!this.ignoreErrors&&!this._all&&v==="error")return arguments[1]instanceof Error?Promise.reject(arguments[1]):Promise.reject("Uncaught, unspecified 'error' event.");return Promise.all(j)},z.prototype.on=function(v,w,U){return this._on(v,w,!1,U)},z.prototype.prependListener=function(v,w,U){return this._on(v,w,!0,U)},z.prototype.onAny=function(v){return this._onAny(v,!1)},z.prototype.prependAny=function(v){return this._onAny(v,!0)},z.prototype.addListener=z.prototype.on,z.prototype._onAny=function(v,w){if(typeof v!="function")throw new Error("onAny only accepts instances of Function");return this._all||(this._all=[]),w?this._all.unshift(v):this._all.push(v),this},z.prototype._on=function(v,w,U,N){if(typeof v=="function")return this._onAny(v,w),this;if(typeof w!="function")throw new Error("on only accepts instances of Function");this._events||d.call(this);var V=this,K;return N!==t&&(K=$.call(this,v,w,N),w=K[0],V=K[1]),this._newListener&&this.emit("newListener",v,w),this.wildcard?(M.call(this,v,w,U),V):(this._events[v]?(typeof this._events[v]=="function"&&(this._events[v]=[this._events[v]]),U?this._events[v].unshift(w):this._events[v].push(w),!this._events[v].warned&&this._maxListeners>0&&this._events[v].length>this._maxListeners&&(this._events[v].warned=!0,g.call(this,this._events[v].length,v))):this._events[v]=w,V)},z.prototype.off=function(v,w){if(typeof w!="function")throw new Error("removeListener only takes instances of Function");var U,N=[];if(this.wildcard){var V=typeof v=="string"?v.split(this.delimiter):v.slice();if(N=E.call(this,null,V,this.listenerTree,0),!N)return this}else{if(!this._events[v])return this;U=this._events[v],N.push({_listeners:U})}for(var K=0;K<N.length;K++){var I=N[K];if(U=I._listeners,r(U)){for(var k=-1,j=0,q=U.length;j<q;j++)if(U[j]===w||U[j].listener&&U[j].listener===w||U[j]._origin&&U[j]._origin===w){k=j;break}if(k<0)continue;return this.wildcard?I._listeners.splice(k,1):this._events[v].splice(k,1),U.length===0&&(this.wildcard?delete I._listeners:delete this._events[v]),this._removeListener&&this.emit("removeListener",v,w),this}else(U===w||U.listener&&U.listener===w||U._origin&&U._origin===w)&&(this.wildcard?delete I._listeners:delete this._events[v],this._removeListener&&this.emit("removeListener",v,w))}return this.listenerTree&&H(this.listenerTree),this},z.prototype.offAny=function(v){var w=0,U=0,N;if(v&&this._all&&this._all.length>0){for(N=this._all,w=0,U=N.length;w<U;w++)if(v===N[w])return N.splice(w,1),this._removeListener&&this.emit("removeListenerAny",v),this}else{if(N=this._all,this._removeListener)for(w=0,U=N.length;w<U;w++)this.emit("removeListenerAny",N[w]);this._all=[]}return this},z.prototype.removeListener=z.prototype.off,z.prototype.removeAllListeners=function(v){if(v===t)return!this._events||d.call(this),this;if(this.wildcard){var w=E.call(this,null,v,this.listenerTree,0),U,N;if(!w)return this;for(N=0;N<w.length;N++)U=w[N],U._listeners=null;this.listenerTree&&H(this.listenerTree)}else this._events&&(this._events[v]=null);return this},z.prototype.listeners=function(v){var w=this._events,U,N,V,K,I;if(v===t){if(this.wildcard)throw Error("event name required for wildcard emitter");if(!w)return[];for(U=h(w),K=U.length,V=[];K-- >0;)N=w[U[K]],typeof N=="function"?V.push(N):V.push.apply(V,N);return V}else{if(this.wildcard){if(I=this.listenerTree,!I)return[];var k=[],j=typeof v=="string"?v.split(this.delimiter):v.slice();return E.call(this,k,j,I,0),k}return w?(N=w[v],N?typeof N=="function"?[N]:N:[]):[]}},z.prototype.eventNames=function(v){var w=this._events;return this.wildcard?C.call(this,this.listenerTree,[],null,v):w?h(w):[]},z.prototype.listenerCount=function(v){return this.listeners(v).length},z.prototype.hasListeners=function(v){if(this.wildcard){var w=[],U=typeof v=="string"?v.split(this.delimiter):v.slice();return E.call(this,w,U,this.listenerTree,0),w.length>0}var N=this._events,V=this._all;return!!(V&&V.length||N&&(v===t?h(N).length:N[v]))},z.prototype.listenersAny=function(){return this._all?this._all:[]},z.prototype.waitFor=function(v,w){var U=this,N=typeof w;return N==="number"?w={timeout:w}:N==="function"&&(w={filter:w}),w=T(w,{timeout:0,filter:t,handleError:!1,Promise,overload:!1},{filter:B,Promise:S}),P(w.Promise,function(V,K,I){function k(){var j=w.filter;if(!(j&&!j.apply(U,arguments)))if(U.off(v,k),w.handleError){var q=arguments[0];q?K(q):V(x.apply(null,arguments).slice(1))}else V(x.apply(null,arguments))}I(function(){U.off(v,k)}),U._on(v,k,!1)},{timeout:w.timeout,overload:w.overload})};function Y(v,w,U){U=T(U,{Promise,timeout:0,overload:!1},{Promise:S});var N=U.Promise;return P(N,function(V,K,I){var k;if(typeof v.addEventListener=="function"){k=function(){V(x.apply(null,arguments))},I(function(){v.removeEventListener(w,k)}),v.addEventListener(w,k,{once:!0});return}var j=function(){q&&v.removeListener("error",q),V(x.apply(null,arguments))},q;w!=="error"&&(q=function(le){v.removeListener(w,j),K(le)},v.once("error",q)),I(function(){q&&v.removeListener("error",q),v.removeListener(w,j)}),v.once(w,j)},{timeout:U.timeout,overload:U.overload})}var te=z.prototype;Object.defineProperties(z,{defaultMaxListeners:{get:function(){return te._maxListeners},set:function(v){if(typeof v!="number"||v<0||Number.isNaN(v))throw TypeError("n must be a non-negative number");te._maxListeners=v},enumerable:!0},once:{value:Y,writable:!0,configurable:!0}}),Object.defineProperties(te,{_maxListeners:{value:s,writable:!0,configurable:!0},_observers:{value:null,writable:!0,configurable:!0}}),i.exports=z})()}(Yr)),Yr.exports}var jr,Ya;function br(){if(Ya)return jr;Ya=1;var i=pc();wi();var e=On().EventEmitter2;function t(n){n=n||{},this.ros=n.ros,this.name=n.name,this.serviceType=n.serviceType,this.isAdvertised=!1,this._serviceCallback=null}return t.prototype.__proto__=e.prototype,t.prototype.callService=function(n,r,s){if(!this.isAdvertised){var o="call_service:"+this.name+":"+ ++this.ros.idCounter;(r||s)&&this.ros.once(o,function(l){l.result!==void 0&&l.result===!1?typeof s=="function"&&s(l.values):typeof r=="function"&&r(new i(l.values))});var a={op:"call_service",id:o,service:this.name,type:this.serviceType,args:n};this.ros.callOnConnection(a)}},t.prototype.advertise=function(n){this.isAdvertised||typeof n!="function"||(this._serviceCallback=n,this.ros.on(this.name,this._serviceResponse.bind(this)),this.ros.callOnConnection({op:"advertise_service",type:this.serviceType,service:this.name}),this.isAdvertised=!0)},t.prototype.unadvertise=function(){this.isAdvertised&&(this.ros.callOnConnection({op:"unadvertise_service",service:this.name}),this.isAdvertised=!1)},t.prototype._serviceResponse=function(n){var r={},s=this._serviceCallback(n.args,r),o={op:"service_response",service:this.name,values:new i(r),result:s};n.id&&(o.id=n.id),this.ros.callOnConnection(o)},jr=t,jr}var $r,ja;function va(){if(ja)return $r;ja=1;var i=fc(),e=Lu(),t=Ou(),n=br(),r=wi(),s=Nn,o=On().EventEmitter2;function a(l){l=l||{};var c=this;this.socket=null,this.idCounter=0,this.isConnected=!1,this.transportLibrary=l.transportLibrary||"websocket",this.transportOptions=l.transportOptions||{},this._sendFunc=function(u){c.sendEncodedMessage(u)},typeof l.groovyCompatibility>"u"?this.groovyCompatibility=!0:this.groovyCompatibility=l.groovyCompatibility,this.setMaxListeners(0),l.url&&this.connect(l.url)}return a.prototype.__proto__=o.prototype,a.prototype.connect=function(l){if(this.transportLibrary==="socket.io")this.socket=s(io(l,{"force new connection":!0}),t(this)),this.socket.on("connect",this.socket.onopen),this.socket.on("data",this.socket.onmessage),this.socket.on("close",this.socket.onclose),this.socket.on("error",this.socket.onerror);else if(this.transportLibrary.constructor.name==="RTCPeerConnection")this.socket=s(this.transportLibrary.createDataChannel(l,this.transportOptions),t(this));else if(this.transportLibrary==="websocket"){if(!this.socket||this.socket.readyState===i.CLOSED){var c=new i(l);c.binaryType="arraybuffer",this.socket=s(c,t(this))}}else if(this.transportLibrary==="workersocket")this.socket=s(new e(l),t(this));else throw"Unknown transportLibrary: "+this.transportLibrary.toString()},a.prototype.close=function(){this.socket&&this.socket.close()},a.prototype.authenticate=function(l,c,u,h,d,f,g){var x={op:"auth",mac:l,client:c,dest:u,rand:h,t:d,level:f,end:g};this.callOnConnection(x)},a.prototype.sendEncodedMessage=function(l){var c=null,u=this;this.transportLibrary==="socket.io"?c=function(h){u.socket.emit("operation",h)}:c=function(h){u.socket.send(h)},this.isConnected?c(l):u.once("connection",function(){c(l)})},a.prototype.callOnConnection=function(l){this.transportOptions.encoder?this.transportOptions.encoder(l,this._sendFunc):this._sendFunc(JSON.stringify(l))},a.prototype.setStatusLevel=function(l,c){var u={op:"set_level",level:l,id:c};this.callOnConnection(u)},a.prototype.getActionServers=function(l,c){var u=new n({ros:this,name:"/rosapi/action_servers",serviceType:"rosapi/GetActionServers"}),h=new r({});typeof c=="function"?u.callService(h,function(d){l(d.action_servers)},function(d){c(d)}):u.callService(h,function(d){l(d.action_servers)})},a.prototype.getTopics=function(l,c){var u=new n({ros:this,name:"/rosapi/topics",serviceType:"rosapi/Topics"}),h=new r;typeof c=="function"?u.callService(h,function(d){l(d)},function(d){c(d)}):u.callService(h,function(d){l(d)})},a.prototype.getTopicsForType=function(l,c,u){var h=new n({ros:this,name:"/rosapi/topics_for_type",serviceType:"rosapi/TopicsForType"}),d=new r({type:l});typeof u=="function"?h.callService(d,function(f){c(f.topics)},function(f){u(f)}):h.callService(d,function(f){c(f.topics)})},a.prototype.getServices=function(l,c){var u=new n({ros:this,name:"/rosapi/services",serviceType:"rosapi/Services"}),h=new r;typeof c=="function"?u.callService(h,function(d){l(d.services)},function(d){c(d)}):u.callService(h,function(d){l(d.services)})},a.prototype.getServicesForType=function(l,c,u){var h=new n({ros:this,name:"/rosapi/services_for_type",serviceType:"rosapi/ServicesForType"}),d=new r({type:l});typeof u=="function"?h.callService(d,function(f){c(f.services)},function(f){u(f)}):h.callService(d,function(f){c(f.services)})},a.prototype.getServiceRequestDetails=function(l,c,u){var h=new n({ros:this,name:"/rosapi/service_request_details",serviceType:"rosapi/ServiceRequestDetails"}),d=new r({type:l});typeof u=="function"?h.callService(d,function(f){c(f)},function(f){u(f)}):h.callService(d,function(f){c(f)})},a.prototype.getServiceResponseDetails=function(l,c,u){var h=new n({ros:this,name:"/rosapi/service_response_details",serviceType:"rosapi/ServiceResponseDetails"}),d=new r({type:l});typeof u=="function"?h.callService(d,function(f){c(f)},function(f){u(f)}):h.callService(d,function(f){c(f)})},a.prototype.getNodes=function(l,c){var u=new n({ros:this,name:"/rosapi/nodes",serviceType:"rosapi/Nodes"}),h=new r;typeof c=="function"?u.callService(h,function(d){l(d.nodes)},function(d){c(d)}):u.callService(h,function(d){l(d.nodes)})},a.prototype.getNodeDetails=function(l,c,u){var h=new n({ros:this,name:"/rosapi/node_details",serviceType:"rosapi/NodeDetails"}),d=new r({node:l});typeof u=="function"?h.callService(d,function(f){c(f.subscribing,f.publishing,f.services)},function(f){u(f)}):h.callService(d,function(f){c(f)})},a.prototype.getParams=function(l,c){var u=new n({ros:this,name:"/rosapi/get_param_names",serviceType:"rosapi/GetParamNames"}),h=new r;typeof c=="function"?u.callService(h,function(d){l(d.names)},function(d){c(d)}):u.callService(h,function(d){l(d.names)})},a.prototype.getTopicType=function(l,c,u){var h=new n({ros:this,name:"/rosapi/topic_type",serviceType:"rosapi/TopicType"}),d=new r({topic:l});typeof u=="function"?h.callService(d,function(f){c(f.type)},function(f){u(f)}):h.callService(d,function(f){c(f.type)})},a.prototype.getServiceType=function(l,c,u){var h=new n({ros:this,name:"/rosapi/service_type",serviceType:"rosapi/ServiceType"}),d=new r({service:l});typeof u=="function"?h.callService(d,function(f){c(f.type)},function(f){u(f)}):h.callService(d,function(f){c(f.type)})},a.prototype.getMessageDetails=function(l,c,u){var h=new n({ros:this,name:"/rosapi/message_details",serviceType:"rosapi/MessageDetails"}),d=new r({type:l});typeof u=="function"?h.callService(d,function(f){c(f.typedefs)},function(f){u(f)}):h.callService(d,function(f){c(f.typedefs)})},a.prototype.decodeTypeDefs=function(l){var c=this,u=function(h,d){for(var f={},g=0;g<h.fieldnames.length;g++){var x=h.fieldarraylen[g],m=h.fieldnames[g],p=h.fieldtypes[g];if(p.indexOf("/")===-1)x===-1?f[m]=p:f[m]=[p];else{for(var T=!1,S=0;S<d.length;S++)if(d[S].type.toString()===p.toString()){T=d[S];break}if(T){var A=u(T,d);x===-1?f[m]=A:f[m]=[A]}else c.emit("error","Cannot find "+p+" in decodeTypeDefs")}}return f};return u(l[0],l)},a.prototype.getTopicsAndRawTypes=function(l,c){var u=new n({ros:this,name:"/rosapi/topics_and_raw_types",serviceType:"rosapi/TopicsAndRawTypes"}),h=new r;typeof c=="function"?u.callService(h,function(d){l(d)},function(d){c(d)}):u.callService(h,function(d){l(d)})},$r=a,$r}var Kr,$a;function mi(){if($a)return Kr;$a=1;var i=Nn;function e(t){i(this,t)}return Kr=e,Kr}var Zr,Ka;function Ai(){if(Ka)return Zr;Ka=1;var i=On().EventEmitter2,e=mi();function t(n){n=n||{},this.ros=n.ros,this.name=n.name,this.messageType=n.messageType,this.isAdvertised=!1,this.compression=n.compression||"none",this.throttle_rate=n.throttle_rate||0,this.latch=n.latch||!1,this.queue_size=n.queue_size||100,this.queue_length=n.queue_length||0,this.reconnect_on_close=n.reconnect_on_close!==void 0?n.reconnect_on_close:!0,this.compression&&this.compression!=="png"&&this.compression!=="cbor"&&this.compression!=="cbor-raw"&&this.compression!=="none"&&(this.emit("warning",this.compression+" compression is not supported. No compression will be used."),this.compression="none"),this.throttle_rate<0&&(this.emit("warning",this.throttle_rate+" is not allowed. Set to 0"),this.throttle_rate=0);var r=this;this.reconnect_on_close?this.callForSubscribeAndAdvertise=function(s){r.ros.callOnConnection(s),r.waitForReconnect=!1,r.reconnectFunc=function(){r.waitForReconnect||(r.waitForReconnect=!0,r.ros.callOnConnection(s),r.ros.once("connection",function(){r.waitForReconnect=!1}))},r.ros.on("close",r.reconnectFunc)}:this.callForSubscribeAndAdvertise=this.ros.callOnConnection,this._messageCallback=function(s){r.emit("message",new e(s))}}return t.prototype.__proto__=i.prototype,t.prototype.subscribe=function(n){typeof n=="function"&&this.on("message",n),!this.subscribeId&&(this.ros.on(this.name,this._messageCallback),this.subscribeId="subscribe:"+this.name+":"+ ++this.ros.idCounter,this.callForSubscribeAndAdvertise({op:"subscribe",id:this.subscribeId,type:this.messageType,topic:this.name,compression:this.compression,throttle_rate:this.throttle_rate,queue_length:this.queue_length}))},t.prototype.unsubscribe=function(n){n&&(this.off("message",n),this.listeners("message").length)||this.subscribeId&&(this.ros.off(this.name,this._messageCallback),this.reconnect_on_close&&this.ros.off("close",this.reconnectFunc),this.emit("unsubscribe"),this.ros.callOnConnection({op:"unsubscribe",id:this.subscribeId,topic:this.name}),this.subscribeId=null)},t.prototype.advertise=function(){if(!this.isAdvertised&&(this.advertiseId="advertise:"+this.name+":"+ ++this.ros.idCounter,this.callForSubscribeAndAdvertise({op:"advertise",id:this.advertiseId,type:this.messageType,topic:this.name,latch:this.latch,queue_size:this.queue_size}),this.isAdvertised=!0,!this.reconnect_on_close)){var n=this;this.ros.on("close",function(){n.isAdvertised=!1})}},t.prototype.unadvertise=function(){this.isAdvertised&&(this.reconnect_on_close&&this.ros.off("close",this.reconnectFunc),this.emit("unadvertise"),this.ros.callOnConnection({op:"unadvertise",id:this.advertiseId,topic:this.name}),this.isAdvertised=!1)},t.prototype.publish=function(n){this.isAdvertised||this.advertise(),this.ros.idCounter++;var r={op:"publish",id:"publish:"+this.name+":"+this.ros.idCounter,topic:this.name,msg:n,latch:this.latch};this.ros.callOnConnection(r)},Zr=t,Zr}var Jr,Za;function Fu(){if(Za)return Jr;Za=1;var i=br(),e=wi();function t(n){n=n||{},this.ros=n.ros,this.name=n.name}return t.prototype.get=function(n,r){var s=new i({ros:this.ros,name:"/rosapi/get_param",serviceType:"rosapi/GetParam"}),o=new e({name:this.name});s.callService(o,function(a){var l=JSON.parse(a.value);n(l)},r)},t.prototype.set=function(n,r,s){var o=new i({ros:this.ros,name:"/rosapi/set_param",serviceType:"rosapi/SetParam"}),a=new e({name:this.name,value:JSON.stringify(n)});o.callService(a,r,s)},t.prototype.delete=function(n,r){var s=new i({ros:this.ros,name:"/rosapi/delete_param",serviceType:"rosapi/DeleteParam"}),o=new e({name:this.name});s.callService(o,n,r)},Jr=t,Jr}var Ja;function Bu(){if(Ja)return Dr.exports;Ja=1;var i=_a(),e=Dr.exports={Ros:va(),Topic:Ai(),Message:mi(),Param:Fu(),Service:br(),ServiceRequest:wi(),ServiceResponse:pc()};return i(e.Ros,["Param","Service","Topic"],e),Dr.exports}var Qr={exports:{}},es,Qa;function mc(){if(Qa)return es;Qa=1;var i=Ai(),e=mi(),t=On().EventEmitter2;function n(r){var s=this;r=r||{},this.ros=r.ros,this.serverName=r.serverName,this.actionName=r.actionName,this.timeout=r.timeout,this.omitFeedback=r.omitFeedback,this.omitStatus=r.omitStatus,this.omitResult=r.omitResult,this.goals={};var o=!1;this.feedbackListener=new i({ros:this.ros,name:this.serverName+"/feedback",messageType:this.actionName+"Feedback"}),this.statusListener=new i({ros:this.ros,name:this.serverName+"/status",messageType:"actionlib_msgs/GoalStatusArray"}),this.resultListener=new i({ros:this.ros,name:this.serverName+"/result",messageType:this.actionName+"Result"}),this.goalTopic=new i({ros:this.ros,name:this.serverName+"/goal",messageType:this.actionName+"Goal"}),this.cancelTopic=new i({ros:this.ros,name:this.serverName+"/cancel",messageType:"actionlib_msgs/GoalID"}),this.goalTopic.advertise(),this.cancelTopic.advertise(),this.omitStatus||this.statusListener.subscribe(function(a){o=!0,a.status_list.forEach(function(l){var c=s.goals[l.goal_id.id];c&&c.emit("status",l)})}),this.omitFeedback||this.feedbackListener.subscribe(function(a){var l=s.goals[a.status.goal_id.id];l&&(l.emit("status",a.status),l.emit("feedback",a.feedback))}),this.omitResult||this.resultListener.subscribe(function(a){var l=s.goals[a.status.goal_id.id];l&&(l.emit("status",a.status),l.emit("result",a.result))}),this.timeout&&setTimeout(function(){o||s.emit("timeout")},this.timeout)}return n.prototype.__proto__=t.prototype,n.prototype.cancel=function(){var r=new e;this.cancelTopic.publish(r)},n.prototype.dispose=function(){this.goalTopic.unadvertise(),this.cancelTopic.unadvertise(),this.omitStatus||this.statusListener.unsubscribe(),this.omitFeedback||this.feedbackListener.unsubscribe(),this.omitResult||this.resultListener.unsubscribe()},es=n,es}var ts,eo;function ku(){if(eo)return ts;eo=1;var i=Ai();mi();var e=On().EventEmitter2;function t(n){var r=this;n=n||{},this.ros=n.ros,this.serverName=n.serverName,this.actionName=n.actionName;var s=new i({ros:this.ros,name:this.serverName+"/goal",messageType:this.actionName+"Goal"}),o=new i({ros:this.ros,name:this.serverName+"/feedback",messageType:this.actionName+"Feedback"}),a=new i({ros:this.ros,name:this.serverName+"/status",messageType:"actionlib_msgs/GoalStatusArray"}),l=new i({ros:this.ros,name:this.serverName+"/result",messageType:this.actionName+"Result"});s.subscribe(function(c){r.emit("goal",c)}),a.subscribe(function(c){c.status_list.forEach(function(u){r.emit("status",u)})}),o.subscribe(function(c){r.emit("status",c.status),r.emit("feedback",c.feedback)}),l.subscribe(function(c){r.emit("status",c.status),r.emit("result",c.result)})}return t.prototype.__proto__=e.prototype,ts=t,ts}var ns,to;function gc(){if(to)return ns;to=1;var i=mi(),e=On().EventEmitter2;function t(n){var r=this;this.actionClient=n.actionClient,this.goalMessage=n.goalMessage,this.isFinished=!1;var s=new Date;this.goalID="goal_"+Math.random()+"_"+s.getTime(),this.goalMessage=new i({goal_id:{stamp:{secs:0,nsecs:0},id:this.goalID},goal:this.goalMessage}),this.on("status",function(o){r.status=o}),this.on("result",function(o){r.isFinished=!0,r.result=o}),this.on("feedback",function(o){r.feedback=o}),this.actionClient.goals[this.goalID]=this}return t.prototype.__proto__=e.prototype,t.prototype.send=function(n){var r=this;r.actionClient.goalTopic.publish(r.goalMessage),n&&setTimeout(function(){r.isFinished||r.emit("timeout")},n)},t.prototype.cancel=function(){var n=new i({id:this.goalID});this.actionClient.cancelTopic.publish(n)},ns=t,ns}var is,no;function zu(){if(no)return is;no=1;var i=Ai(),e=mi(),t=On().EventEmitter2;function n(r){var s=this;r=r||{},this.ros=r.ros,this.serverName=r.serverName,this.actionName=r.actionName,this.feedbackPublisher=new i({ros:this.ros,name:this.serverName+"/feedback",messageType:this.actionName+"Feedback"}),this.feedbackPublisher.advertise();var o=new i({ros:this.ros,name:this.serverName+"/status",messageType:"actionlib_msgs/GoalStatusArray"});o.advertise(),this.resultPublisher=new i({ros:this.ros,name:this.serverName+"/result",messageType:this.actionName+"Result"}),this.resultPublisher.advertise();var a=new i({ros:this.ros,name:this.serverName+"/goal",messageType:this.actionName+"Goal"}),l=new i({ros:this.ros,name:this.serverName+"/cancel",messageType:"actionlib_msgs/GoalID"});this.statusMessage=new e({header:{stamp:{secs:0,nsecs:100},frame_id:""},status_list:[]}),this.currentGoal=null,this.nextGoal=null,a.subscribe(function(u){s.currentGoal?(s.nextGoal=u,s.emit("cancel")):(s.statusMessage.status_list=[{goal_id:u.goal_id,status:1}],s.currentGoal=u,s.emit("goal",u.goal))});var c=function(u,h){return u.secs>h.secs?!1:u.secs<h.secs?!0:u.nsecs<h.nsecs};l.subscribe(function(u){u.stamp.secs===0&&u.stamp.secs===0&&u.id===""?(s.nextGoal=null,s.currentGoal&&s.emit("cancel")):(s.currentGoal&&u.id===s.currentGoal.goal_id.id?s.emit("cancel"):s.nextGoal&&u.id===s.nextGoal.goal_id.id&&(s.nextGoal=null),s.nextGoal&&c(s.nextGoal.goal_id.stamp,u.stamp)&&(s.nextGoal=null),s.currentGoal&&c(s.currentGoal.goal_id.stamp,u.stamp)&&s.emit("cancel"))}),setInterval(function(){var u=new Date,h=Math.floor(u.getTime()/1e3),d=Math.round(1e9*(u.getTime()/1e3-h));s.statusMessage.header.stamp.secs=h,s.statusMessage.header.stamp.nsecs=d,o.publish(s.statusMessage)},500)}return n.prototype.__proto__=t.prototype,n.prototype.setSucceeded=function(r){var s=new e({status:{goal_id:this.currentGoal.goal_id,status:3},result:r});this.resultPublisher.publish(s),this.statusMessage.status_list=[],this.nextGoal?(this.currentGoal=this.nextGoal,this.nextGoal=null,this.emit("goal",this.currentGoal.goal)):this.currentGoal=null},n.prototype.setAborted=function(r){var s=new e({status:{goal_id:this.currentGoal.goal_id,status:4},result:r});this.resultPublisher.publish(s),this.statusMessage.status_list=[],this.nextGoal?(this.currentGoal=this.nextGoal,this.nextGoal=null,this.emit("goal",this.currentGoal.goal)):this.currentGoal=null},n.prototype.sendFeedback=function(r){var s=new e({status:{goal_id:this.currentGoal.goal_id,status:1},feedback:r});this.feedbackPublisher.publish(s)},n.prototype.setPreempted=function(){this.statusMessage.status_list=[];var r=new e({status:{goal_id:this.currentGoal.goal_id,status:2}});this.resultPublisher.publish(r),this.nextGoal?(this.currentGoal=this.nextGoal,this.nextGoal=null,this.emit("goal",this.currentGoal.goal)):this.currentGoal=null},is=n,is}var ro;function Vu(){if(ro)return Qr.exports;ro=1;var i=va(),e=_a(),t=Qr.exports={ActionClient:mc(),ActionListener:ku(),Goal:gc(),SimpleActionServer:zu()};return e(i,["ActionClient","SimpleActionServer"],t),Qr.exports}var rs,so;function Fn(){if(so)return rs;so=1;function i(e){e=e||{},this.x=e.x||0,this.y=e.y||0,this.z=e.z||0}return i.prototype.add=function(e){this.x+=e.x,this.y+=e.y,this.z+=e.z},i.prototype.subtract=function(e){this.x-=e.x,this.y-=e.y,this.z-=e.z},i.prototype.multiplyQuaternion=function(e){var t=e.w*this.x+e.y*this.z-e.z*this.y,n=e.w*this.y+e.z*this.x-e.x*this.z,r=e.w*this.z+e.x*this.y-e.y*this.x,s=-e.x*this.x-e.y*this.y-e.z*this.z;this.x=t*e.w+s*-e.x+n*-e.z-r*-e.y,this.y=n*e.w+s*-e.y+r*-e.x-t*-e.z,this.z=r*e.w+s*-e.z+t*-e.y-n*-e.x},i.prototype.clone=function(){return new i(this)},rs=i,rs}var ss,ao;function Ci(){if(ao)return ss;ao=1;function i(e){e=e||{},this.x=e.x||0,this.y=e.y||0,this.z=e.z||0,this.w=typeof e.w=="number"?e.w:1}return i.prototype.conjugate=function(){this.x*=-1,this.y*=-1,this.z*=-1},i.prototype.norm=function(){return Math.sqrt(this.x*this.x+this.y*this.y+this.z*this.z+this.w*this.w)},i.prototype.normalize=function(){var e=Math.sqrt(this.x*this.x+this.y*this.y+this.z*this.z+this.w*this.w);e===0?(this.x=0,this.y=0,this.z=0,this.w=1):(e=1/e,this.x=this.x*e,this.y=this.y*e,this.z=this.z*e,this.w=this.w*e)},i.prototype.invert=function(){this.conjugate(),this.normalize()},i.prototype.multiply=function(e){var t=this.x*e.w+this.y*e.z-this.z*e.y+this.w*e.x,n=-this.x*e.z+this.y*e.w+this.z*e.x+this.w*e.y,r=this.x*e.y-this.y*e.x+this.z*e.w+this.w*e.z,s=-this.x*e.x-this.y*e.y-this.z*e.z+this.w*e.w;this.x=t,this.y=n,this.z=r,this.w=s},i.prototype.clone=function(){return new i(this)},ss=i,ss}var as,oo;function xa(){if(oo)return as;oo=1;var i=Fn(),e=Ci();function t(n){n=n||{},this.position=new i(n.position),this.orientation=new e(n.orientation)}return t.prototype.applyTransform=function(n){this.position.multiplyQuaternion(n.rotation),this.position.add(n.translation);var r=n.rotation.clone();r.multiply(this.orientation),this.orientation=r},t.prototype.clone=function(){return new t(this)},t.prototype.multiply=function(n){var r=n.clone();return r.applyTransform({rotation:this.orientation,translation:this.position}),r},t.prototype.getInverse=function(){var n=this.clone();return n.orientation.invert(),n.position.multiplyQuaternion(n.orientation),n.position.x*=-1,n.position.y*=-1,n.position.z*=-1,n},as=t,as}var os,lo;function _c(){if(lo)return os;lo=1;var i=Fn(),e=Ci();function t(n){n=n||{},this.translation=new i(n.translation),this.rotation=new e(n.rotation)}return t.prototype.clone=function(){return new t(this)},os=t,os}var ls,co;function Gu(){return co||(co=1,ls={Pose:xa(),Quaternion:Ci(),Transform:_c(),Vector3:Fn()}),ls}var cs={exports:{}},us,uo;function Hu(){if(uo)return us;uo=1;var i=mc(),e=gc(),t=br(),n=wi(),r=Ai(),s=_c();function o(a){a=a||{},this.ros=a.ros,this.fixedFrame=a.fixedFrame||"base_link",this.angularThres=a.angularThres||2,this.transThres=a.transThres||.01,this.rate=a.rate||10,this.updateDelay=a.updateDelay||50;var l=a.topicTimeout||2,c=Math.floor(l),u=Math.floor((l-c)*1e9);this.topicTimeout={secs:c,nsecs:u},this.serverName=a.serverName||"/tf2_web_republisher",this.repubServiceName=a.repubServiceName||"/republish_tfs",this.currentGoal=!1,this.currentTopic=!1,this.frameInfos={},this.republisherUpdateRequested=!1,this._subscribeCB=null,this._isDisposed=!1,this.actionClient=new i({ros:a.ros,serverName:this.serverName,actionName:"tf2_web_republisher/TFSubscriptionAction",omitStatus:!0,omitResult:!0}),this.serviceClient=new t({ros:a.ros,name:this.repubServiceName,serviceType:"tf2_web_republisher/RepublishTFs"})}return o.prototype.processTFArray=function(a){a.transforms.forEach(function(l){var c=l.child_frame_id;c[0]==="/"&&(c=c.substring(1));var u=this.frameInfos[c];u&&(u.transform=new s({translation:l.transform.translation,rotation:l.transform.rotation}),u.cbs.forEach(function(h){h(u.transform)}))},this)},o.prototype.updateGoal=function(){var a={source_frames:Object.keys(this.frameInfos),target_frame:this.fixedFrame,angular_thres:this.angularThres,trans_thres:this.transThres,rate:this.rate};if(this.ros.groovyCompatibility)this.currentGoal&&this.currentGoal.cancel(),this.currentGoal=new e({actionClient:this.actionClient,goalMessage:a}),this.currentGoal.on("feedback",this.processTFArray.bind(this)),this.currentGoal.send();else{a.timeout=this.topicTimeout;var l=new n(a);this.serviceClient.callService(l,this.processResponse.bind(this))}this.republisherUpdateRequested=!1},o.prototype.processResponse=function(a){this._isDisposed||(this.currentTopic&&this.currentTopic.unsubscribe(this._subscribeCB),this.currentTopic=new r({ros:this.ros,name:a.topic_name,messageType:"tf2_web_republisher/TFArray"}),this._subscribeCB=this.processTFArray.bind(this),this.currentTopic.subscribe(this._subscribeCB))},o.prototype.subscribe=function(a,l){a[0]==="/"&&(a=a.substring(1)),this.frameInfos[a]?this.frameInfos[a].transform&&l(this.frameInfos[a].transform):(this.frameInfos[a]={cbs:[]},this.republisherUpdateRequested||(setTimeout(this.updateGoal.bind(this),this.updateDelay),this.republisherUpdateRequested=!0)),this.frameInfos[a].cbs.push(l)},o.prototype.unsubscribe=function(a,l){a[0]==="/"&&(a=a.substring(1));for(var c=this.frameInfos[a],u=c&&c.cbs||[],h=u.length;h--;)u[h]===l&&u.splice(h,1);(!l||u.length===0)&&delete this.frameInfos[a]},o.prototype.dispose=function(){this._isDisposed=!0,this.actionClient.dispose(),this.currentTopic&&this.currentTopic.unsubscribe(this._subscribeCB)},us=o,us}var ho;function Wu(){if(ho)return cs.exports;ho=1;var i=va(),e=_a(),t=cs.exports={TFClient:Hu()};return e(i,["TFClient"],t),cs.exports}var hs,fo;function Ri(){return fo||(fo=1,hs={URDF_SPHERE:0,URDF_BOX:1,URDF_CYLINDER:2,URDF_MESH:3}),hs}var ds,po;function vc(){if(po)return ds;po=1;var i=Fn(),e=Ri();function t(n){this.dimension=null,this.type=e.URDF_BOX;var r=n.xml.getAttribute("size").split(" ");this.dimension=new i({x:parseFloat(r[0]),y:parseFloat(r[1]),z:parseFloat(r[2])})}return ds=t,ds}var fs,mo;function xc(){if(mo)return fs;mo=1;function i(e){var t=e.xml.getAttribute("rgba").split(" ");this.r=parseFloat(t[0]),this.g=parseFloat(t[1]),this.b=parseFloat(t[2]),this.a=parseFloat(t[3])}return fs=i,fs}var ps,go;function yc(){if(go)return ps;go=1;var i=Ri();function e(t){this.type=i.URDF_CYLINDER,this.length=parseFloat(t.xml.getAttribute("length")),this.radius=parseFloat(t.xml.getAttribute("radius"))}return ps=e,ps}var ms,_o;function ya(){if(_o)return ms;_o=1;var i=xc();function e(n){this.textureFilename=null,this.color=null,this.name=n.xml.getAttribute("name");var r=n.xml.getElementsByTagName("texture");r.length>0&&(this.textureFilename=r[0].getAttribute("filename"));var s=n.xml.getElementsByTagName("color");s.length>0&&(this.color=new i({xml:s[0]}))}e.prototype.isLink=function(){return this.color===null&&this.textureFilename===null};var t=Nn;return e.prototype.assign=function(n){return t(this,n)},ms=e,ms}var gs,vo;function Sc(){if(vo)return gs;vo=1;var i=Fn(),e=Ri();function t(n){this.scale=null,this.type=e.URDF_MESH,this.filename=n.xml.getAttribute("filename");var r=n.xml.getAttribute("scale");if(r){var s=r.split(" ");this.scale=new i({x:parseFloat(s[0]),y:parseFloat(s[1]),z:parseFloat(s[2])})}}return gs=t,gs}var _s,xo;function Mc(){if(xo)return _s;xo=1;var i=Ri();function e(t){this.type=i.URDF_SPHERE,this.radius=parseFloat(t.xml.getAttribute("radius"))}return _s=e,_s}var vs,yo;function bc(){if(yo)return vs;yo=1;var i=xa(),e=Fn(),t=Ci(),n=yc(),r=vc(),s=ya(),o=Sc(),a=Mc();function l(c){var u=c.xml;this.origin=null,this.geometry=null,this.material=null,this.name=c.xml.getAttribute("name");var h=u.getElementsByTagName("origin");if(h.length===0)this.origin=new i;else{var d=h[0].getAttribute("xyz"),f=new e;d&&(d=d.split(" "),f=new e({x:parseFloat(d[0]),y:parseFloat(d[1]),z:parseFloat(d[2])}));var g=h[0].getAttribute("rpy"),x=new t;if(g){g=g.split(" ");var m=parseFloat(g[0]),p=parseFloat(g[1]),T=parseFloat(g[2]),S=m/2,A=p/2,B=T/2,D=Math.sin(S)*Math.cos(A)*Math.cos(B)-Math.cos(S)*Math.sin(A)*Math.sin(B),P=Math.cos(S)*Math.sin(A)*Math.cos(B)+Math.sin(S)*Math.cos(A)*Math.sin(B),X=Math.cos(S)*Math.cos(A)*Math.sin(B)-Math.sin(S)*Math.sin(A)*Math.cos(B),E=Math.cos(S)*Math.cos(A)*Math.cos(B)+Math.sin(S)*Math.sin(A)*Math.sin(B);x=new t({x:D,y:P,z:X,w:E}),x.normalize()}this.origin=new i({position:f,orientation:x})}var M=u.getElementsByTagName("geometry");if(M.length>0){for(var C=M[0],H=null,O=0;O<C.childNodes.length;O++){var $=C.childNodes[O];if($.nodeType===1){H=$;break}}var z=H.nodeName;z==="sphere"?this.geometry=new a({xml:H}):z==="box"?this.geometry=new r({xml:H}):z==="cylinder"?this.geometry=new n({xml:H}):z==="mesh"?this.geometry=new o({xml:H}):console.warn("Unknown geometry type "+z)}var Y=u.getElementsByTagName("material");Y.length>0&&(this.material=new s({xml:Y[0]}))}return vs=l,vs}var xs,So;function Ec(){if(So)return xs;So=1;var i=bc();function e(t){this.name=t.xml.getAttribute("name"),this.visuals=[];for(var n=t.xml.getElementsByTagName("visual"),r=0;r<n.length;r++)this.visuals.push(new i({xml:n[r]}))}return xs=e,xs}var ys,Mo;function Xu(){if(Mo)return ys;Mo=1;var i=xa(),e=Fn(),t=Ci();function n(r){this.name=r.xml.getAttribute("name"),this.type=r.xml.getAttribute("type");var s=r.xml.getElementsByTagName("parent");s.length>0&&(this.parent=s[0].getAttribute("link"));var o=r.xml.getElementsByTagName("child");o.length>0&&(this.child=o[0].getAttribute("link"));var a=r.xml.getElementsByTagName("limit");a.length>0&&(this.minval=parseFloat(a[0].getAttribute("lower")),this.maxval=parseFloat(a[0].getAttribute("upper")));var l=r.xml.getElementsByTagName("origin");if(l.length===0)this.origin=new i;else{var c=l[0].getAttribute("xyz"),u=new e;c&&(c=c.split(" "),u=new e({x:parseFloat(c[0]),y:parseFloat(c[1]),z:parseFloat(c[2])}));var h=l[0].getAttribute("rpy"),d=new t;if(h){h=h.split(" ");var f=parseFloat(h[0]),g=parseFloat(h[1]),x=parseFloat(h[2]),m=f/2,p=g/2,T=x/2,S=Math.sin(m)*Math.cos(p)*Math.cos(T)-Math.cos(m)*Math.sin(p)*Math.sin(T),A=Math.cos(m)*Math.sin(p)*Math.cos(T)+Math.sin(m)*Math.cos(p)*Math.sin(T),B=Math.cos(m)*Math.cos(p)*Math.sin(T)-Math.sin(m)*Math.sin(p)*Math.cos(T),D=Math.cos(m)*Math.cos(p)*Math.cos(T)+Math.sin(m)*Math.sin(p)*Math.sin(T);d=new t({x:S,y:A,z:B,w:D}),d.normalize()}this.origin=new i({position:u,orientation:d})}}return ys=n,ys}var vi={},bo;function qu(){return bo||(bo=1,vi.DOMImplementation=window.DOMImplementation,vi.XMLSerializer=window.XMLSerializer,vi.DOMParser=window.DOMParser),vi}var Ss,Eo;function Yu(){if(Eo)return Ss;Eo=1;var i=ya(),e=Ec(),t=Xu(),n=qu().DOMParser;function r(s){s=s||{};var o=s.xml,a=s.string;if(this.materials={},this.links={},this.joints={},a){var l=new n;o=l.parseFromString(a,"text/xml")}var c=o.documentElement;this.name=c.getAttribute("name");for(var u=c.childNodes,h=0;h<u.length;h++){var d=u[h];if(d.tagName==="material"){var f=new i({xml:d});this.materials[f.name]!==void 0?this.materials[f.name].isLink()?this.materials[f.name].assign(f):console.warn("Material "+f.name+"is not unique."):this.materials[f.name]=f}else if(d.tagName==="link"){var g=new e({xml:d});if(this.links[g.name]!==void 0)console.warn("Link "+g.name+" is not unique.");else{for(var x=0;x<g.visuals.length;x++){var m=g.visuals[x].material;m!==null&&m.name&&(this.materials[m.name]!==void 0?g.visuals[x].material=this.materials[m.name]:this.materials[m.name]=m)}this.links[g.name]=g}}else if(d.tagName==="joint"){var p=new t({xml:d});this.joints[p.name]=p}}}return Ss=r,Ss}var Ms,To;function ju(){return To||(To=1,Ms=Nn({UrdfBox:vc(),UrdfColor:xc(),UrdfCylinder:yc(),UrdfLink:Ec(),UrdfMaterial:ya(),UrdfMesh:Sc(),UrdfModel:Yu(),UrdfSphere:Mc(),UrdfVisual:bc()},Ri())),Ms}var gi=dc.ROSLIB||{REVISION:"1.4.1"},Pi=Nn;Pi(gi,Bu());Pi(gi,Vu());Pi(gi,Gu());Pi(gi,Wu());Pi(gi,ju());var $u=gi;const Ke=bu($u);function Ku(i,e){return i.id===17||i.id===16?{data:0}:i.id===5?{data:2}:i.id===18?{data:3}:i.id===19?{data:Number(e.globalZ)||0}:i.id===23?{data:Number(e.speed)||0}:i.id===24?{data:Number(e.fixedSpeed)||0}:{data:1}}function Zu(i,e){return i.id===2?{position:{x:Number(e.startX)||0,y:Number(e.startY)||0,z:Number(e.startZ)||0},orientation:{x:Number(e.globalX)||0,y:Number(e.globalY)||0,z:Number(e.stepX)||0,w:Number(e.stepY)||0}}:i.id===6?{position:{x:Number(e.fixedX)||0,y:Number(e.fixedY)||0,z:Number(e.fixedZ)||0},orientation:{x:Number(e.fixedTheta)||0,y:0,z:0,w:1}}:i.id===7?{position:{x:Number(e.startX)||0,y:Number(e.startY)||0,z:Number(e.startZ)||0},orientation:{x:Number(e.speed)||0,y:0,z:0,w:1}}:i.id===22?{position:{x:Number(e.fixedX)||0,y:Number(e.fixedY)||0,z:Number(e.fixedZ)||0},orientation:{x:0,y:0,z:0,w:1}}:{position:{x:0,y:0,z:0},orientation:{x:0,y:0,z:0,w:1}}}class Ju{constructor({rosConnection:e,callbacks:t={}}){this.rosConnection=e,this.callbacks=t,this.publisherCache=new Map,this.toggleStates=new Map(Object.entries(hr()).map(([n,r])=>[n,r.value]))}reset(){this.publisherCache.clear(),this.toggleStates=new Map(Object.entries(hr()).map(([e,t])=>[e,t.value]))}getToggleStateSnapshot(){return Object.entries(hr()).reduce((e,[t,n])=>{var s,o,a,l;const r=this.toggleStates.has(t)?this.toggleStates.get(t):n.value;return e[t]={value:r,label:r?(s=cn(t))==null?void 0:s.activeLabel:(o=cn(t))==null?void 0:o.inactiveLabel,tone:r?(a=cn(t))==null?void 0:a.activeTone:(l=cn(t))==null?void 0:l.inactiveTone},e},{})}handle(e,t){var a,l,c,u,h,d,f,g,x,m,p,T;const n=oa.find(S=>S.id===e);if(!n){(l=(a=this.callbacks).onResultMessage)==null||l.call(a,`未识别的老前端命令: ${e}`),(u=(c=this.callbacks).onLog)==null||u.call(c,`未识别的老前端命令: ${e}`,"warn");return}const r=this.rosConnection.getResources();if(!(r!=null&&r.ros)){(d=(h=this.callbacks).onResultMessage)==null||d.call(h,`ROS 未连接，无法执行: ${n.name}`),(g=(f=this.callbacks).onLog)==null||g.call(f,`ROS 未连接，无法执行: ${n.name}`,"warn");return}const s=this.getOrCreatePublisher(r.ros,n.topic,n.type),o=this.buildMessagePayload(n,t);s.publish(new Ke.Message(o)),(m=(x=this.callbacks).onResultMessage)==null||m.call(x,`已发送 ${n.name} -> ${n.topic}`),(T=(p=this.callbacks).onLog)==null||T.call(p,`已发送 ${n.name} -> ${n.topic}`,"success")}handleToggle(e,t){var f,g,x,m,p,T,S,A,B,D,P,X,E,M,C,H;const n=cn(e);if(!n)return(g=(f=this.callbacks).onResultMessage)==null||g.call(f,`未识别的开关动作: ${e}`),(m=(x=this.callbacks).onLog)==null||m.call(x,`未识别的开关动作: ${e}`,"warn"),null;const r=this.rosConnection.getResources();if(!(r!=null&&r.ros))return(T=(p=this.callbacks).onResultMessage)==null||T.call(p,`ROS 未连接，无法执行: ${n.inactiveLabel}/${n.activeLabel}`),(A=(S=this.callbacks).onLog)==null||A.call(S,`ROS 未连接，无法执行开关: ${e}`,"warn"),null;const o=!(this.toggleStates.has(e)?this.toggleStates.get(e):!!n.initialValue),a=this.resolveToggleCommand(n,o);if(!a)return(D=(B=this.callbacks).onResultMessage)==null||D.call(B,`开关 ${e} 缺少对应命令`),(X=(P=this.callbacks).onLog)==null||X.call(P,`开关 ${e} 缺少对应命令`,"error"),null;const l=this.getOrCreatePublisher(r.ros,a.topic,a.type),c=this.buildToggleMessagePayload(n,a,o,t);l.publish(new Ke.Message(c)),this.toggleStates.set(e,o);const u=o?n.activeLabel:n.inactiveLabel,h=o?n.activeTone:n.inactiveTone,d=o?"已开启":"已关闭";return(M=(E=this.callbacks).onResultMessage)==null||M.call(E,`${u}，${d}`),(H=(C=this.callbacks).onLog)==null||H.call(C,`已发送 ${a.name} -> ${a.topic}，状态=${d}`,"success"),{value:o,label:u,tone:h}}getOrCreatePublisher(e,t,n){const r=`${t}|${n}`;if(this.publisherCache.has(r))return this.publisherCache.get(r);const s=new Ke.Topic({ros:e,name:t,messageType:n});return s.advertise(),this.publisherCache.set(r,s),s}buildMessagePayload(e,t){return e.type==="std_msgs/Float32"?Ku(e,t):e.type==="geometry_msgs/Pose"?Zu(e,t):{}}resolveToggleCommand(e,t){const n=t?e.activateCommandId??e.commandId:e.deactivateCommandId??e.commandId;return oa.find(r=>r.id===n)||null}buildToggleMessagePayload(e,t,n,r){return e.messageType==="std_msgs/Bool"||t.type==="std_msgs/Bool"?{data:n}:this.buildMessagePayload(t,r)}}function Qu({pathname:i="/",savedPreferences:e=null,currentHost:t="localhost"}={}){if(i&&i.length>1)try{const n=decodeURIComponent(i.substring(1));if(n.startsWith("ws://")||n.startsWith("wss://"))return n}catch{}return t?`ws://${t}:9090`:e!=null&&e.ip?`ws://${e.ip}:${e.port||"9090"}`:"ws://localhost:9090"}const eh="/Scepter/ir/image_raw",th="/web/pointAI/set_workspace_quad",nh="/web/pointAI/run_workspace_s2",ih="/pointAI/manual_workspace_quad_pixels",rh="/pointAI/result_image_raw",sh="/Scepter/worldCoord/world_coord",ah="/Scepter/worldCoord/raw_world_coord",oh="/coordinate_point",lh="/cabin/pseudo_slam_markers",ch="/system_log/all",uh="/tf",hh="/tf_static",dh="/web/cabin/start_pseudo_slam_scan",fh="/web/cabin/start_global_work",ph="/web/cabin/run_bind_path_direct_test",mh="/cabin/set_execution_mode",gh="tie_robot_msgs/StartPseudoSlamScanTaskAction",_h="tie_robot_msgs/StartGlobalWorkTaskAction",vh="tie_robot_msgs/RunBindPathDirectTestTaskAction",xh="tie_robot_msgs/SetExecutionMode";class yh{constructor(e={}){this.callbacks=e,this.ros=null,this.resources=null,this.topicSubscribers=[]}connect(){var t,n,r,s;const e=Qu({pathname:window.location.pathname,currentHost:window.location.hostname});(n=(t=this.callbacks).onConnectionInfo)==null||n.call(t,e,"连接中","info"),(s=(r=this.callbacks).onLog)==null||s.call(r,`开始连接 ROSBridge: ${e}`,"info"),this.ros=new Ke.Ros({url:e}),this.resources=this.buildResources(this.ros),this.ros.on("connection",()=>{var o,a,l,c,u,h;this.resources.workspaceQuadPublisher.advertise(),this.resources.runWorkspaceS2Publisher.advertise(),this.bindSubscriptions(),(a=(o=this.callbacks).onConnectionInfo)==null||a.call(o,e,"连接成功","success"),(c=(l=this.callbacks).onRosReady)==null||c.call(l,this.resources),(h=(u=this.callbacks).onLog)==null||h.call(u,"ROS 连接成功，动作链与图像订阅已就绪","success")}),this.ros.on("error",o=>{var l,c,u,h,d,f;const a=(o==null?void 0:o.message)||String(o);(c=(l=this.callbacks).onConnectionInfo)==null||c.call(l,e,"连接失败","error"),(h=(u=this.callbacks).onRosUnavailable)==null||h.call(u),(f=(d=this.callbacks).onLog)==null||f.call(d,`ROS 连接失败: ${a}`,"error")}),this.ros.on("close",()=>{var o,a,l,c,u,h;this.unbindSubscriptions(),(a=(o=this.callbacks).onConnectionInfo)==null||a.call(o,e,"连接失败","warn"),(c=(l=this.callbacks).onRosUnavailable)==null||c.call(l),(h=(u=this.callbacks).onLog)==null||h.call(u,"ROS 连接已断开","warn")})}buildResources(e){return{ros:e,workspaceQuadPublisher:new Ke.Topic({ros:e,name:th,messageType:"std_msgs/Float32MultiArray"}),runWorkspaceS2Publisher:new Ke.Topic({ros:e,name:nh,messageType:"std_msgs/Bool"}),startPseudoSlamScanActionClient:new Ke.ActionClient({ros:e,serverName:dh,actionName:gh}),executionModeService:new Ke.Service({ros:e,name:mh,serviceType:xh}),startGlobalWorkActionClient:new Ke.ActionClient({ros:e,serverName:fh,actionName:_h}),runDirectBindPathTestActionClient:new Ke.ActionClient({ros:e,serverName:ph,actionName:vh})}}bindSubscriptions(){this.unbindSubscriptions();const e=[new Ke.Topic({ros:this.ros,name:eh,messageType:"sensor_msgs/Image"}),new Ke.Topic({ros:this.ros,name:ih,messageType:"std_msgs/Float32MultiArray"}),new Ke.Topic({ros:this.ros,name:rh,messageType:"sensor_msgs/Image"}),new Ke.Topic({ros:this.ros,name:sh,messageType:"sensor_msgs/Image"}),new Ke.Topic({ros:this.ros,name:ah,messageType:"sensor_msgs/Image"}),new Ke.Topic({ros:this.ros,name:oh,messageType:"tie_robot_msgs/PointsArray"}),new Ke.Topic({ros:this.ros,name:lh,messageType:"visualization_msgs/MarkerArray"}),new Ke.Topic({ros:this.ros,name:ch,messageType:"rosgraph_msgs/Log"}),new Ke.Topic({ros:this.ros,name:uh,messageType:"tf2_msgs/TFMessage"}),new Ke.Topic({ros:this.ros,name:hh,messageType:"tf2_msgs/TFMessage"})];e[0].subscribe(t=>{var n,r;return(r=(n=this.callbacks).onBaseImage)==null?void 0:r.call(n,t)}),e[1].subscribe(t=>{var n,r;return(r=(n=this.callbacks).onSavedWorkspacePayload)==null?void 0:r.call(n,Array.from(t.data||[]))}),e[2].subscribe(t=>{var n,r;return(r=(n=this.callbacks).onExecutionOverlay)==null?void 0:r.call(n,t)}),e[3].subscribe(t=>{var n,r;return(r=(n=this.callbacks).onPointCloudImage)==null?void 0:r.call(n,"filteredWorldCoord",t)}),e[4].subscribe(t=>{var n,r;return(r=(n=this.callbacks).onPointCloudImage)==null?void 0:r.call(n,"rawWorldCoord",t)}),e[5].subscribe(t=>{var n,r;return(r=(n=this.callbacks).onTiePoints)==null?void 0:r.call(n,t)}),e[6].subscribe(t=>{var n,r;return(r=(n=this.callbacks).onPlanningMarkers)==null?void 0:r.call(n,t)}),e[7].subscribe(t=>{var n,r;return(r=(n=this.callbacks).onSystemLog)==null?void 0:r.call(n,t)}),e[8].subscribe(t=>{var n,r;return(r=(n=this.callbacks).onTfMessage)==null?void 0:r.call(n,t)}),e[9].subscribe(t=>{var n,r;return(r=(n=this.callbacks).onTfMessage)==null?void 0:r.call(n,t)}),this.topicSubscribers=e}unbindSubscriptions(){this.topicSubscribers.forEach(e=>{try{e.unsubscribe()}catch{}}),this.topicSubscribers=[]}getResources(){return this.resources}isReady(){return!!(this.resources&&this.ros&&this.ros.isConnected)}}const Tc=[{id:"ros",label:"ROS",kind:"connection"},{id:"chassis",label:"索驱",topic:"/robot/chassis_status",messageType:"std_msgs/Float32"},{id:"moduan",label:"末端",topic:"/robot/moduan_status",messageType:"std_msgs/Float32"},{id:"bindingGun",label:"绑扎枪",topic:"/robot/binding_gun_status",messageType:"std_msgs/Float32"}],Sh="/moduan/moduan_gesture_data",Mh="tie_robot_msgs/linear_module_upload";function bh(i){return Number.isFinite(i)?i<0?"error":i>0?"success":"info":"warn"}class Eh{constructor(e={}){this.callbacks=e,this.subscriptions=[],this.lastValues=new Map}setConnectionState(e,t){var n,r;(r=(n=this.callbacks).onStatusChip)==null||r.call(n,"ros",e,t)}start(e){this.stop(),Tc.filter(n=>n.kind!=="connection").forEach(n=>{const r=new Ke.Topic({ros:e,name:n.topic,messageType:n.messageType});r.subscribe(s=>{var c,u,h,d;const o=Number(s==null?void 0:s.data),a=bh(o),l=`${n.label}: ${Number.isFinite(o)?o:"无效值"}`;(u=(c=this.callbacks).onStatusChip)==null||u.call(c,n.id,a,l),this.lastValues.get(n.id)!==o&&((d=(h=this.callbacks).onLog)==null||d.call(h,`状态变化 ${n.label} -> ${l}`,a),this.lastValues.set(n.id,o))}),this.subscriptions.push(r)});const t=new Ke.Topic({ros:e,name:Sh,messageType:Mh});t.subscribe(n=>{var s,o,a,l;const r=Number(n==null?void 0:n.robot_battery_voltage);if((o=(s=this.callbacks).onBatteryVoltage)==null||o.call(s,r),this.lastValues.get("robot_battery_voltage")!==r){const c=Number.isFinite(r)&&r>0?`机器人电压 ${r.toFixed(1)}V`:"机器人电压无效";(l=(a=this.callbacks).onLog)==null||l.call(a,`状态变化 电压 -> ${c}`,Number.isFinite(r)&&r>0?"info":"warn"),this.lastValues.set("robot_battery_voltage",r)}}),this.subscriptions.push(t)}stop(){var e,t;this.subscriptions.forEach(n=>{try{n.unsubscribe()}catch{}}),this.subscriptions=[],this.lastValues.delete("robot_battery_voltage"),(t=(e=this.callbacks).onBatteryVoltage)==null||t.call(e,Number.NaN)}}function Th(i,e,t){return{x:Math.min(Math.max(Math.round(i.x),0),Math.max(e-1,0)),y:Math.min(Math.max(Math.round(i.y),0),Math.max(t-1,0))}}function bs({clientX:i,clientY:e,rect:t,imageWidth:n,imageHeight:r}){const s=Math.max((t==null?void 0:t.width)||0,1),o=Math.max((t==null?void 0:t.height)||0,1),a=(i-((t==null?void 0:t.left)||0))/s*n,l=(e-((t==null?void 0:t.top)||0))/o*r;return Th({x:a,y:l},n,r)}function wc(i){if(!Array.isArray(i)||i.length!==4)throw new Error("Workspace quad requires exactly four points");return i.flatMap(e=>[Math.round(e.x),Math.round(e.y)])}function wh(i){if(!Array.isArray(i)||i.length!==8)throw new Error("Workspace quad payload requires exactly eight values");const e=[];for(let t=0;t<i.length;t+=2)e.push({x:Number(i[t]),y:Number(i[t+1])});return e}function Ah(i,e,t=12){if(!Array.isArray(i)||!e)return-1;let n=-1,r=Number.POSITIVE_INFINITY;const s=t*t;return i.forEach((o,a)=>{const l=Number(o.x)-Number(e.x),c=Number(o.y)-Number(e.y),u=l*l+c*c;u<=s&&u<r&&(r=u,n=a)}),n}function Ch(i,e,t){return(i||[]).map((n,r)=>r!==e?n:{x:Number(t.x),y:Number(t.y)})}function Ac(i){if(Array.isArray(i))return Uint8ClampedArray.from(i);if(typeof i=="string"){const e=atob(i),t=new Uint8ClampedArray(e.length);for(let n=0;n<e.length;n+=1)t[n]=e.charCodeAt(n);return t}return i instanceof Uint8Array||i instanceof Uint8ClampedArray?new Uint8ClampedArray(i):(i==null?void 0:i.buffer)instanceof ArrayBuffer?new Uint8ClampedArray(i.buffer):null}function wo(i,e){const t=new Uint32Array(256);for(let o=0;o<i.length;o+=1)t[i[o]]+=1;const n=Math.min(Math.max(e,0),100),r=Math.max(Math.ceil(n/100*i.length),1);let s=0;for(let o=0;o<t.length;o+=1)if(s+=t[o],s>=r)return o;return 255}function Rh(i,{lowClipPercent:e=1,highClipPercent:t=99}={}){const n=wo(i,e),r=wo(i,t);if(r<=n)return Uint8ClampedArray.from(i);const s=new Uint8ClampedArray(i.length),o=255/(r-n);for(let a=0;a<i.length;a+=1){const l=Math.round((i[a]-n)*o);s[a]=Math.min(Math.max(l,0),255)}return s}function Ph(i,e=1){const t=Number.isFinite(e)&&e>0?e:1,n=new Uint8ClampedArray(i.length);for(let r=0;r<i.length;r+=1)n[r]=Math.round(255*(i[r]/255)**t);return n}function Lh(i){const e=new Uint32Array(256);for(let a=0;a<i.length;a+=1)e[i[a]]+=1;let t=0;const n=new Uint32Array(256);let r=0;for(let a=0;a<e.length;a+=1)r+=e[a],n[a]=r,t===0&&e[a]>0&&(t=r);if(t===i.length)return Uint8ClampedArray.from(i);const s=new Uint8ClampedArray(i.length),o=Math.max(i.length-t,1);for(let a=0;a<i.length;a+=1)s[a]=Math.round((n[i[a]]-t)/o*255);return s}function Uh(i,{mode:e="auto",gamma:t=.85}={}){if(e==="raw")return Uint8ClampedArray.from(i);let n=Rh(i);return e==="strong"&&(n=Lh(n)),Ph(n,t)}function Ao(i,e){const t=Ac(i.data),n=Number(i.width)||0,r=Number(i.height)||0,s=String(i.encoding||"").toLowerCase();if(!t||n<=0||r<=0)throw new Error("图像数据无效");const o=new Uint8ClampedArray(n*r*4);if(s.includes("mono8")||s.includes("8uc1")){const a=Uh(t,e);for(let l=0;l<n*r;l+=1){const c=a[l]??0,u=l*4;o[u]=c,o[u+1]=c,o[u+2]=c,o[u+3]=255}return new ImageData(o,n,r)}if(s.includes("rgb8")||s.includes("bgr8")){for(let a=0;a<n*r;a+=1){const l=a*3,c=a*4,u=s.includes("bgr8")?[t[l+2],t[l+1],t[l]]:[t[l],t[l+1],t[l+2]];o[c]=u[0]??0,o[c+1]=u[1]??0,o[c+2]=u[2]??0,o[c+3]=255}return new ImageData(o,n,r)}throw new Error(`暂不支持的图像编码: ${i.encoding}`)}function Dh(i,{sampleStep:e=4,maxPoints:t=24e3}={}){const n=Ac(i==null?void 0:i.data),r=Number(i==null?void 0:i.width)||0,s=Number(i==null?void 0:i.height)||0;if(!n||r<=0||s<=0)return{positions:new Float32Array,count:0};const o=new DataView(n.buffer,n.byteOffset,n.byteLength),a=Math.max(1,Number(e)||1),l=[];let c=0;for(let u=0;u<s;u+=a)for(let h=0;h<r;h+=a){const d=(u*r+h)*12;if(d+12>o.byteLength)continue;const f=o.getFloat32(d,!0),g=o.getFloat32(d+4,!0),x=o.getFloat32(d+8,!0);if(!(!Number.isFinite(f)||!Number.isFinite(g)||!Number.isFinite(x))&&!(f===0&&g===0&&x===0)&&(l.push(f/1e3,g/1e3,x/1e3),c+=1,c>=t))return{positions:Float32Array.from(l),count:c}}return{positions:Float32Array.from(l),count:c}}class Ih{constructor({rosConnection:e,workspaceView:t,callbacks:n={}}){this.rosConnection=e,this.workspaceView=t,this.callbacks=n}handle(e){switch(e){case"submitQuad":return this.publishWorkspaceQuad();case"runSavedS2":return this.triggerSavedWorkspaceS2();case"scanPlan":return this.triggerPseudoSlamScan();case"startExecution":return this.triggerExecutionLayer(!0);case"startExecutionKeepMemory":return this.triggerExecutionLayer(!1);case"runBindPathTest":return this.triggerBindPathDirectTest();default:this.report(`未识别的任务动作: ${e}`,"warn")}}publishWorkspaceQuad(){var r,s,o,a;const e=this.rosConnection.getResources(),t=this.workspaceView.getSelectedPoints();if(!(e!=null&&e.workspaceQuadPublisher)||!(e!=null&&e.runWorkspaceS2Publisher)||t.length!==4){this.report("当前还不能提交工作区四边形，请先连上 ROS 并点满 4 个角点","warn");return}const n=wc(t);this.workspaceView.setExecutionOverlayMessage(null),e.workspaceQuadPublisher.publish(new Ke.Message({data:n})),(s=(r=this.callbacks).onResultMessage)==null||s.call(r,`工作区四边形已发送，正在触发 S2，覆盖层统一等待 result_img: [${n.join(", ")}]`),(a=(o=this.callbacks).onLog)==null||a.call(o,`已发送工作区四边形: [${n.join(", ")}]`,"success"),window.setTimeout(()=>{e.runWorkspaceS2Publisher.publish(new Ke.Message({data:!0}))},180)}triggerSavedWorkspaceS2(){var n,r,s,o;const e=this.rosConnection.getResources(),t=this.workspaceView.getSavedWorkspacePoints();if(!(e!=null&&e.runWorkspaceS2Publisher)||t.length!==4){this.report("当前没有可复用的已保存工作区，请先点 4 个角点并提交","warn");return}this.workspaceView.setExecutionOverlayMessage(null),e.runWorkspaceS2Publisher.publish(new Ke.Message({data:!0})),(r=(n=this.callbacks).onResultMessage)==null||r.call(n,"正在使用当前已保存工作区识别绑扎点，覆盖层统一等待 result_img..."),(o=(s=this.callbacks).onLog)==null||o.call(s,"已触发基于已保存工作区的 S2 识别","success")}triggerPseudoSlamScan(){var t,n,r,s;const e=this.rosConnection.getResources();if(!(e!=null&&e.startPseudoSlamScanActionClient)){this.report("ROS 还没连好，暂时不能开始固定扫描规划","warn");return}this.workspaceView.setExecutionOverlayMessage(null),(n=(t=this.callbacks).onResultMessage)==null||n.call(t,"正在执行固定工作区扫描：移动到 x=-260, y=1700, z=2997, speed=100，然后触发 S2 并动态规划，覆盖层统一显示 result_img。"),(s=(r=this.callbacks).onLog)==null||s.call(r,"已触发固定扫描建图任务","success"),this.sendActionGoal(e.startPseudoSlamScanActionClient,{goalMessage:{enable_capture_gate:!1,scan_strategy:2},feedbackPrefix:"扫描建图进行中",successPrefix:"扫描建图完成",failurePrefix:"扫描建图失败"})}triggerExecutionLayer(e){var r,s,o,a;const t=this.rosConnection.getResources();if(!(t!=null&&t.executionModeService)||!(t!=null&&t.startGlobalWorkActionClient)){this.report("ROS 还没连好，暂时不能开始执行层","warn");return}this.workspaceView.setExecutionOverlayMessage(null),(s=(r=this.callbacks).onResultMessage)==null||s.call(r,"工作区覆盖层统一使用 result_img，后续显示 /pointAI/result_image_raw。"),(a=(o=this.callbacks).onLog)==null||a.call(o,e?"准备清记忆并开始执行层":"准备保留记忆直接开始执行层","success");const n=new Ke.ServiceRequest({execution_mode:1});t.executionModeService.callService(n,l=>{if(!(l!=null&&l.success)){this.report(`执行模式切换失败: ${(l==null?void 0:l.message)||"未知错误"}`,"error");return}this.sendActionGoal(t.startGlobalWorkActionClient,{goalMessage:{clear_execution_memory:e,execution_mode:1},feedbackPrefix:"执行层进行中",successPrefix:"执行层任务完成",failurePrefix:"执行层任务失败"})},l=>this.report(`执行模式切换失败: ${(l==null?void 0:l.message)||String(l)}`,"error"))}triggerBindPathDirectTest(){var t,n,r,s;const e=this.rosConnection.getResources();if(!(e!=null&&e.runDirectBindPathTestActionClient)){this.report("ROS 还没连好，暂时不能直接执行账本测试","warn");return}(n=(t=this.callbacks).onResultMessage)==null||n.call(t,"直接执行账本测试已触发：后端将只按 pseudo_slam_bind_path.json 的 path_origin、cabin_pose 和 x/y/z 执行。"),(s=(r=this.callbacks).onLog)==null||s.call(r,"已触发直接执行账本测试","success"),this.sendActionGoal(e.runDirectBindPathTestActionClient,{goalMessage:{},feedbackPrefix:"账本测试进行中",successPrefix:"账本测试完成",failurePrefix:"账本测试失败"})}sendActionGoal(e,{goalMessage:t,feedbackPrefix:n,successPrefix:r,failurePrefix:s}){const o=new Ke.Goal({actionClient:e,goalMessage:t});o.on("feedback",a=>{var c,u;const l=(a==null?void 0:a.detail)||(a==null?void 0:a.stage)||"处理中";(u=(c=this.callbacks).onResultMessage)==null||u.call(c,`${n}: ${l}`)}),o.on("result",a=>{var c,u,h,d,f,g,x,m;const l=(a==null?void 0:a.message)||"未知结果";if(a!=null&&a.success){(u=(c=this.callbacks).onResultMessage)==null||u.call(c,`${r}: ${l}`),(d=(h=this.callbacks).onLog)==null||d.call(h,`${r}: ${l}`,"success");return}(g=(f=this.callbacks).onResultMessage)==null||g.call(f,`${s}: ${l}`),(m=(x=this.callbacks).onLog)==null||m.call(x,`${s}: ${l}`,"error")}),o.send()}report(e,t="info"){var n,r,s,o;(r=(n=this.callbacks).onResultMessage)==null||r.call(n,e),(o=(s=this.callbacks).onLog)==null||o.call(s,e,t)}}const Cc=[{id:"onlyPointCloud",label:"只显示点云"},{id:"onlyTiePoints",label:"只显示绑扎点"},{id:"pointCloudAndTiePoints",label:"点云 + 绑扎点"},{id:"planningFocus",label:"规划点/执行点"},{id:"machineOnly",label:"只显示机器"},{id:"all",label:"全开"}],Rc=[{id:"filteredWorldCoord",label:"滤波世界点云"},{id:"rawWorldCoord",label:"原始世界点云"}],Pc=[{id:"camera",label:"相机视角"},{id:"global",label:"全局视角"}];function Sa(i,e,t=e){var n;return((n=i.find(r=>r.id===e))==null?void 0:n.label)||t}const Co={onlyPointCloud:{showRobot:!1,showAxes:!1,showPointCloud:!0,showTiePoints:!1,showPlanningMarkers:!1},onlyTiePoints:{showRobot:!1,showAxes:!0,showPointCloud:!1,showTiePoints:!0,showPlanningMarkers:!1},pointCloudAndTiePoints:{showRobot:!0,showAxes:!0,showPointCloud:!0,showTiePoints:!0,showPlanningMarkers:!1},planningFocus:{showRobot:!0,showAxes:!0,showPointCloud:!1,showTiePoints:!1,showPlanningMarkers:!0},machineOnly:{showRobot:!0,showAxes:!0,showPointCloud:!1,showTiePoints:!1,showPlanningMarkers:!1},all:{showRobot:!0,showAxes:!0,showPointCloud:!0,showTiePoints:!0,showPlanningMarkers:!0}},Nh={mode:"pointCloudAndTiePoints",pointCloudSource:"filteredWorldCoord",showRobot:!0,showAxes:!0,showPointCloud:!0,showTiePoints:!0,showPlanningMarkers:!1,pointSize:.035,pointOpacity:.78,viewMode:"camera",followCamera:!1};function Oh(i,e){const t=Co[i]||Co.pointCloudAndTiePoints;return{...e,mode:i,...t}}function Lc(i){return Sa(Cc,i)}function Fh(i){return Sa(Rc,i)}function Bh(i){return Sa(Pc,i)}class kh{constructor({ui:e,sceneView:t,callbacks:n={}}){this.ui=e,this.sceneView=t,this.callbacks=n,this.state={...Nh},this.stats={filteredWorldCoordCount:0,rawWorldCoordCount:0,tiePointCount:0,planningPointCount:0,tfFrameCount:0}}init(){this.ui.setTopicLayerState(this.state),this.ui.renderTopicLayerStats(this.stats),this.sceneView.setLayerState(this.state),this.sceneView.setViewMode(this.state.viewMode),this.sceneView.setFollowCamera(this.state.followCamera)}handleLayerControlsChange(e){var r,s;const t=e.mode||this.state.mode;let n={...this.state,...e};e.mode&&e.mode!==this.state.mode&&(n=Oh(t,n)),this.state=n,this.ui.setTopicLayerState(this.state),this.sceneView.setLayerState(this.state),(s=(r=this.callbacks).onLog)==null||s.call(r,`三维图层模式已切换为 ${Lc(this.state.mode)}`,"info")}handleSceneControlsChange(e){var t,n;this.state={...this.state,...e},this.ui.setTopicLayerState(this.state),this.sceneView.setViewMode(this.state.viewMode),this.sceneView.setFollowCamera(this.state.followCamera),(n=(t=this.callbacks).onLog)==null||n.call(t,`三维视角已切换为 ${Bh(this.state.viewMode)}${this.state.followCamera?"（跟随相机）":""}`,"info")}updateStats(e){this.stats={...this.stats,...e},this.ui.renderTopicLayerStats(this.stats)}getState(){return{...this.state}}}class zh{constructor(){this.panels=new Map}registerPanel(e){if(!e)return;const t=e.querySelector(".panel-header");if(!t)return;let n=!1,r=0,s=0,o=0,a=0;const l=()=>{let h=20;this.panels.forEach(d=>{h=Math.max(h,Number(d.style.zIndex||20))}),e.style.zIndex=String(h+1)},c=h=>{if(!n)return;const d=h.clientX-o,f=h.clientY-a;e.style.left=`${r+d}px`,e.style.top=`${s+f}px`,e.style.right="auto"},u=()=>{n=!1,document.removeEventListener("pointermove",c),document.removeEventListener("pointerup",u)};t.addEventListener("pointerdown",h=>{if(window.innerWidth<=1100||h.target.closest("button, a, input, select, label"))return;n=!0,l();const f=e.getBoundingClientRect();r=f.left,s=f.top,o=h.clientX,a=h.clientY,e.style.left=`${f.left}px`,e.style.top=`${f.top}px`,e.style.right="auto",document.addEventListener("pointermove",c),document.addEventListener("pointerup",u)}),this.panels.set(e.id,e)}init(e){e.querySelectorAll(".floating-panel").forEach(t=>this.registerPanel(t))}}const Ro=[{id:"controlPanel",label:"控制面板"},{id:"workspacePanel",label:"工作区"},{id:"topicLayersPanel",label:"话题图层"},{id:"logPanel",label:"日志"}],Vh={controlPanel:!0,workspacePanel:!0,topicLayersPanel:!0,logPanel:!1},Gh={auto:"自动增强",strong:"强增强",raw:"原图"},Es={info:"连接中",success:"连接成功",warn:"连接失败",error:"连接失败"};class Hh{constructor(e){this.rootElement=e,this.refs={}}renderShell(){this.rootElement.innerHTML=`
    ...
    `).join("")}renderControlPanelTasks(){this.refs.controlPanelTaskGrid.innerHTML=xu.map(e=>`
      ...
      >${e.label.replaceAll(`
`,"<br />")}</button>
    `).join("")}renderLegacyCommands(){this.refs.controlPanelGroups.innerHTML=Mu().map(({title:e,controls:t})=>`
...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:fn,depthTest:!1,depthWrite:!1})}function Dl(){return new _n({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Ta(),fragmentShader:`
		...
		`,blending:fn,depthTest:!1,depthWrite:!1})}function Il(){return new _n({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Ta(),fragmentShader:`
	...
	`}function pg(i){let e=new WeakMap,t=null;function n(a){if(a&&a.isTexture){const l=a.mapping,c=l===ua||l===ha,u=l===ci||l===ui;if(c||u){let h=e.get(a);const d=h!==void 0?h.texture.pmremVersion:0;if(a.isRenderTargetTexture&&a.pmremVersion!==d)return t===null&&(t=new Ll(i)),h=c?t.fromEquirectangular(a,h):t.fromCubemap(a,h),h.texture.pmremVersion=a.pmremVersion,e.set(a,h),h.texture;if(h!==void 0)return h.texture;{const f=a.image;return c&&f&&f.height>0||u&&f&&r(f)?(t===null&&(t=new Ll(i)),h=c?t.fromEquirectangular(a):t.fromCubemap(a),h.texture.pmremVersion=a.pmremVersion,e.set(a,h),a.addEventListener("dispose",s),h.texture):null}}}return a}function r(a){let l=0;const c=6;for(let u=0;u<c;u++)a[u]!==void 0&&l++;return l===c}function s(a){const l=a.target;l.removeEventListener("dispose",s);const c=e.get(l);c!==void 0&&(e.delete(l),c.dispose())}function o(){e=new WeakMap,t!==null&&(t.dispose(),t=null)}return{get:n,dispose:o}}function mg(i){const e={};function t(n){if(e[n]!==void 0)return e[n];let r;switch(n){case"WEBGL_depth_texture":r=i.getExtension("WEBGL_depth_texture")||i.getExtension("MOZ_WEBGL_depth_texture")||i.getExtension("WEBKIT_WEBGL_depth_texture");break;case"EXT_texture_filter_anisotropic":r=i.getExtension("EXT_texture_filter_anisotropic")||i.getExtension("MOZ_EXT_texture_filter_anisotropic")||i.getExtension("WEBKIT_EXT_texture_filter_anisotropic");break;case"WEBGL_compressed_texture_s3tc":r=i.getExtension("WEBGL_compressed_texture_s3tc")||i.getExtension("MOZ_WEBGL_compressed_texture_s3tc")||i.getExtension("WEBKIT_WEBGL_compressed_texture_s3tc");break;case"WEBGL_compressed_texture_pvrtc":r=i.getExtension("WEBGL_compressed_texture_pvrtc")||i.getExtension("WEBKIT_WEBGL_compressed_texture_pvrtc");break;default:r=i.getExtension(n)}return e[n]=r,r}return{has:function(n){return t(n)!==null},init:function(){t("EXT_color_buffer_float"),t("WEBGL_clip_cull_distance"),t("OES_texture_float_linear"),t("EXT_color_buffer_half_float"),t("WEBGL_multisampled_render_to_texture"),t("WEBGL_render_shared_exponent")},get:function(n){const r=t(n);return r===null&&Xc("THREE.WebGLRenderer: "+n+" extension not supported."),r}}}function gg(i,e,t,n){const r={},s=new WeakMap;function o(h){const d=h.target;d.index!==null&&e.remove(d.index);for(const g in d.attributes)e.remove(d.attributes[g]);for(const g in d.morphAttributes){const x=d.morphAttributes[g];for(let m=0,p=x.length;m<p;m++)e.remove(x[m])}d.removeEventListener("dispose",o),delete r[d.id];const f=s.get(d);f&&(e.remove(f),s.delete(d)),n.releaseStatesOfGeometry(d),d.isInstancedBufferGeometry===!0&&delete d._maxInstanceCount,t.memory.geometries--}function a(h,d){return r[d.id]===!0||(d.addEventListener("dispose",o),r[d.id]=!0,t.memory.geometries++),d}function l(h){const d=h.attributes;for(const g in d)e.update(d[g],i.ARRAY_BUFFER);const f=h.morphAttributes;for(const g in f){const x=f[g];for(let m=0,p=x.length;m<p;m++)e.update(x[m],i.ARRAY_BUFFER)}}function c(h){const d=[],f=h.index,g=h.attributes.position;let x=0;if(f!==null){const T=f.array;x=f.version;for(let S=0,A=T.length;S<A;S+=3){const B=T[S+0],D=T[S+1],P=T[S+2];d.push(B,D,D,P,P,B)}}else if(g!==void 0){const T=g.array;x=g.version;for(let S=0,A=T.length/3-1;S<A;S+=3){const B=S+0,D=S+1,P=S+2;d.push(B,D,D,P,P,B)}}else return;const m=new(Wc(d)?Jc:Zc)(d,1);m.version=x;const p=s.get(h);p&&e.remove(p),s.set(h,m)}function u(h){const d=s.get(h);if(d){const f=h.index;f!==null&&d.version<f.version&&c(h)}else c(h);return s.get(h)}return{get:a,update:l,getWireframeAttribute:u}}function _g(i,e,t){let n;function r(d){n=d}let s,o;function a(d){s=d.type,o=d.bytesPerElement}function l(d,f){i.drawElements(n,f,s,d*o),t.update(f,n,1)}function c(d,f,g){g!==0&&(i.drawElementsInstanced(n,f,s,d*o,g),t.update(f,n,g))}function u(d,f,g){if(g===0)return;const x=e.get("WEBGL_multi_draw");if(x===null)for(let m=0;m<g;m++)this.render(d[m]/o,f[m]);else{x.multiDrawElementsWEBGL(n,f,0,s,d,0,g);let m=0;for(let p=0;p<g;p++)m+=f[p];t.update(m,n,1)}}function h(d,f,g,x){if(g===0)return;const m=e.get("WEBGL_multi_draw");if(m===null)for(let p=0;p<d.length;p++)c(d[p]/o,f[p],x[p]);else{m.multiDrawElementsInstancedWEBGL(n,f,0,s,d,0,x,0,g);let p=0;for(let T=0;T<g;T++)p+=f[T];for(let T=0;T<x.length;T++)t.update(p,n,x[T])}}this.setMode=r,this.setIndex=a,this.render=l,this.renderInstances=c,this.renderMultiDraw=u,this.renderMultiDrawInstances=h}function vg(i){const e={geometries:0,textures:0},t={frame:0,calls:0,triangles:0,points:0,lines:0};function n(s,o,a){switch(t.calls++,o){case i.TRIANGLES:t.triangles+=a*(s/3);break;case i.LINES:t.lines+=a*(s/2);break;case i.LINE_STRIP:t.lines+=a*(s-1);break;case i.LINE_LOOP:t.lines+=a*s;break;case i.POINTS:t.points+=a*s;break;default:console.error("THREE.WebGLInfo: Unknown draw mode:",o);break}}function r(){t.calls=0,t.triangles=0,t.points=0,t.lines=0}return{memory:e,render:t,programs:null,autoReset:!0,reset:r,update:n}}function xg(i,e,t){const n=new WeakMap,r=new ht;function s(o,a,l){const c=o.morphTargetInfluences,u=a.morphAttributes.position||a.morphAttributes.normal||a.morphAttributes.color,h=u!==void 0?u.length:0;let d=n.get(a);if(d===void 0||d.count!==h){let M=function(){X.dispose(),n.delete(a),a.removeEventListener("dispose",M)};var f=M;d!==void 0&&d.texture.dispose();const g=a.morphAttributes.position!==void 0,x=a.morphAttributes.normal!==void 0,m=a.morphAttributes.color!==void 0,p=a.morphAttributes.position||[],T=a.morphAttributes.normal||[],S=a.morphAttributes.color||[];let A=0;g===!0&&(A=1),x===!0&&(A=2),m===!0&&(A=3);let B=a.attributes.position.count*A,D=1;B>e.maxTextureSize&&(D=Math.ceil(B/e.maxTextureSize),B=e.maxTextureSize);const P=new Float32Array(B*D*4*h),X=new Yc(P,B,D,h);X.type=hn,X.needsUpdate=!0;const E=A*4;for(let C=0;C<h;C++){const H=p[C],O=T[C],$=S[C],z=B*D*4*C;for(let Y=0;Y<H.count;Y++){const te=Y*E;g===!0&&(r.fromBufferAttribute(H,Y),P[z+te+0]=r.x,P[z+te+1]=r.y,P[z+te+2]=r.z,P[z+te+3]=0),x===!0&&(r.fromBufferAttribute(O,Y),P[z+te+4]=r.x,P[z+te+5]=r.y,P[z+te+6]=r.z,P[z+te+7]=0),m===!0&&(r.fromBufferAttribute($,Y),P[z+te+8]=r.x,P[z+te+9]=r.y,P[z+te+10]=r.z,P[z+te+11]=$.itemSize===4?r.w:1)}}d={count:h,texture:X,size:new De(B,D)},n.set(a,d),a.addEventListener("dispose",M)}if(o.isInstancedMesh===!0&&o.morphTexture!==null)l.getUniforms().setValue(i,"morphTexture",o.morphTexture,t);else{let g=0;for(let m=0;m<c.length;m++)g+=c[m];const x=a.morphTargetsRelative?1:1-g;l.getUniforms().setValue(i,"morphTargetBaseInfluence",x),l.getUniforms().setValue(i,"morphTargetInfluences",c)}l.getUniforms().setValue(i,"morphTargetsTexture",d.texture,t),l.getUniforms().setValue(i,"morphTargetsTextureSize",d.size)}return{update:s}}function yg(i,e,t,n){let r=new WeakMap;function s(l){const c=n.render.frame,u=l.geometry,h=e.get(l,u);if(r.get(h)!==c&&(e.update(h),r.set(h,c)),l.isInstancedMesh&&(l.hasEventListener("dispose",a)===!1&&l.addEventListener("dispose",a),r.get(l)!==c&&(t.update(l.instanceMatrix,i.ARRAY_BUFFER),l.instanceColor!==null&&t.update(l.instanceColor,i.ARRAY_BUFFER),r.set(l,c))),l.isSkinnedMesh){const d=l.skeleton;r.get(d)!==c&&(d.update(),r.set(d,c))}return h}function o(){r=new WeakMap}function a(l){const c=l.target;c.removeEventListener("dispose",a),t.remove(c.instanceMatrix),c.instanceColor!==null&&t.remove(c.instanceColor)}return{update:s,dispose:o}}class ru extends St{constructor(e,t,n,r,s,o,a,l,c,u=oi){if(u!==oi&&u!==fi)throw new Error("DepthTexture format must be either THREE.DepthFormat or THREE.DepthStencilFormat");n===void 0&&u===oi&&(n=hi),n===void 0&&u===fi&&(n=di),super(null,r,s,o,a,l,u,n,c),this.isDepthTexture=!0,this.image={width:e,height:t},this.magFilter=a!==void 0?a:Pt,this.minFilter=l!==void 0?l:Pt,this.flipY=!1,this.generateMipmaps=!1,this.compareFunction=null}copy(e){return super.copy(e),this.compareFunction=e.compareFunction,this}toJSON(e){const t=super.toJSON(e);return this.compareFunction!==null&&(t.compareFunction=this.compareFunction),t}}const su=new St,au=new ru(1,1);au.compareFunction=Hc;const ou=new Yc,lu=new af,cu=new tu,Nl=[],Ol=[],Fl=new Float32Array(16),Bl=new Float32Array(9),kl=new Float32Array(4);function _i(i,e,t){const n=i[0];if(n<=0||n>0)return i;const r=e*t;let s=Nl[r];if(s===void 0&&(s=new Float32Array(r),Nl[r]=s),e!==0){n.toArray(s,0);for(let o=1,a=0;o!==e;++o)a+=t,i[o].toArray(s,a)}return s}function ot(i,e){if(i.length!==e.length)return!1;for(let t=0,n=i.length;t<n;t++)if(i[t]!==e[t])return!1;return!0}function lt(i,e){for(let t=0,n=e.length;t<n;t++)i[t]=e[t]}function Rr(i,e){let t=Ol[e];t===void 0&&(t=new Int32Array(e),Ol[e]=t);for(let n=0;n!==e;++n)t[n]=i.allocateTextureUnit();return t}function Sg(i,e){const t=this.cache;t[0]!==e&&(i.uniform1f(this.addr,e),t[0]=e)}function Mg(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(i.uniform2f(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(ot(t,e))return;i.uniform2fv(this.addr,e),lt(t,e)}}function bg(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(i.uniform3f(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else if(e.r!==void 0)(t[0]!==e.r||t[1]!==e.g||t[2]!==e.b)&&(i.uniform3f(this.addr,e.r,e.g,e.b),t[0]=e.r,t[1]=e.g,t[2]=e.b);else{if(ot(t,e))return;i.uniform3fv(this.addr,e),lt(t,e)}}function Eg(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(i.uniform4f(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(ot(t,e))return;i.uniform4fv(this.addr,e),lt(t,e)}}function Tg(i,e){const t=this.cache,n=e.elements;if(n===void 0){if(ot(t,e))return;i.uniformMatrix2fv(this.addr,!1,e),lt(t,e)}else{if(ot(t,n))return;kl.set(n),i.uniformMatrix2fv(this.addr,!1,kl),lt(t,n)}}function wg(i,e){const t=this.cache,n=e.elements;if(n===void 0){if(ot(t,e))return;i.uniformMatrix3fv(this.addr,!1,e),lt(t,e)}else{if(ot(t,n))return;Bl.set(n),i.uniformMatrix3fv(this.addr,!1,Bl),lt(t,n)}}function Ag(i,e){const t=this.cache,n=e.elements;if(n===void 0){if(ot(t,e))return;i.uniformMatrix4fv(this.addr,!1,e),lt(t,e)}else{if(ot(t,n))return;Fl.set(n),i.uniformMatrix4fv(this.addr,!1,Fl),lt(t,n)}}function Cg(i,e){const t=this.cache;t[0]!==e&&(i.uniform1i(this.addr,e),t[0]=e)}function Rg(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(i.uniform2i(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(ot(t,e))return;i.uniform2iv(this.addr,e),lt(t,e)}}function Pg(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(i.uniform3i(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(ot(t,e))return;i.uniform3iv(this.addr,e),lt(t,e)}}function Lg(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(i.uniform4i(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(ot(t,e))return;i.uniform4iv(this.addr,e),lt(t,e)}}function Ug(i,e){const t=this.cache;t[0]!==e&&(i.uniform1ui(this.addr,e),t[0]=e)}function Dg(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(i.uniform2ui(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(ot(t,e))return;i.uniform2uiv(this.addr,e),lt(t,e)}}function Ig(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(i.uniform3ui(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(ot(t,e))return;i.uniform3uiv(this.addr,e),lt(t,e)}}function Ng(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(i.uniform4ui(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(ot(t,e))return;i.uniform4uiv(this.addr,e),lt(t,e)}}function Og(i,e,t){const n=this.cache,r=t.allocateTextureUnit();n[0]!==r&&(i.uniform1i(this.addr,r),n[0]=r);const s=this.type===i.SAMPLER_2D_SHADOW?au:su;t.setTexture2D(e||s,r)}function Fg(i,e,t){const n=this.cache,r=t.allocateTextureUnit();n[0]!==r&&(i.uniform1i(this.addr,r),n[0]=r),t.setTexture3D(e||lu,r)}function Bg(i,e,t){const n=this.cache,r=t.allocateTextureUnit();n[0]!==r&&(i.uniform1i(this.addr,r),n[0]=r),t.setTextureCube(e||cu,r)}function kg(i,e,t){const n=this.cache,r=t.allocateTextureUnit();n[0]!==r&&(i.uniform1i(this.addr,r),n[0]=r),t.setTexture2DArray(e||ou,r)}function zg(i){switch(i){case 5126:return Sg;case 35664:return Mg;case 35665:return bg;case 35666:return Eg;case 35674:return Tg;case 35675:return wg;case 35676:return Ag;case 5124:case 35670:return Cg;case 35667:case 35671:return Rg;case 35668:case 35672:return Pg;case 35669:case 35673:return Lg;case 5125:return Ug;case 36294:return Dg;case 36295:return Ig;case 36296:return Ng;case 35678:case 36198:case 36298:case 36306:case 35682:return Og;case 35679:case 36299:case 36307:return Fg;case 35680:case 36300:case 36308:case 36293:return Bg;case 36289:case 36303:case 36311:case 36292:return kg}}function Vg(i,e){i.uniform1fv(this.addr,e)}function Gg(i,e){const t=_i(e,this.size,2);i.uniform2fv(this.addr,t)}function Hg(i,e){const t=_i(e,this.size,3);i.uniform3fv(this.addr,t)}function Wg(i,e){const t=_i(e,this.size,4);i.uniform4fv(this.addr,t)}function Xg(i,e){const t=_i(e,this.size,4);i.uniformMatrix2fv(this.addr,!1,t)}function qg(i,e){const t=_i(e,this.size,9);i.uniformMatrix3fv(this.addr,!1,t)}function Yg(i,e){const t=_i(e,this.size,16);i.uniformMatrix4fv(this.addr,!1,t)}function jg(i,e){i.uniform1iv(this.addr,e)}function $g(i,e){i.uniform2iv(this.addr,e)}function Kg(i,e){i.uniform3iv(this.addr,e)}function Zg(i,e){i.uniform4iv(this.addr,e)}function Jg(i,e){i.uniform1uiv(this.addr,e)}function Qg(i,e){i.uniform2uiv(this.addr,e)}function e_(i,e){i.uniform3uiv(this.addr,e)}function t_(i,e){i.uniform4uiv(this.addr,e)}function n_(i,e,t){const n=this.cache,r=e.length,s=Rr(t,r);ot(n,s)||(i.uniform1iv(this.addr,s),lt(n,s));for(let o=0;o!==r;++o)t.setTexture2D(e[o]||su,s[o])}function i_(i,e,t){const n=this.cache,r=e.length,s=Rr(t,r);ot(n,s)||(i.uniform1iv(this.addr,s),lt(n,s));for(let o=0;o!==r;++o)t.setTexture3D(e[o]||lu,s[o])}function r_(i,e,t){const n=this.cache,r=e.length,s=Rr(t,r);ot(n,s)||(i.uniform1iv(this.addr,s),lt(n,s));for(let o=0;o!==r;++o)t.setTextureCube(e[o]||cu,s[o])}function s_(i,e,t){const n=this.cache,r=e.length,s=Rr(t,r);ot(n,s)||(i.uniform1iv(this.addr,s),lt(n,s));for(let o=0;o!==r;++o)t.setTexture2DArray(e[o]||ou,s[o])}function a_(i){switch(i){case 5126:return Vg;case 35664:return Gg;case 35665:return Hg;case 35666:return Wg;case 35674:return Xg;case 35675:return qg;case 35676:return Yg;case 5124:case 35670:return jg;case 35667:case 35671:return $g;case 35668:case 35672:return Kg;case 35669:case 35673:return Zg;case 5125:return Jg;case 36294:return Qg;case 36295:return e_;case 36296:return t_;case 35678:case 36198:case 36298:case 36306:case 35682:return n_;case 35679:case 36299:case 36307:return i_;case 35680:case 36300:case 36308:case 36293:return r_;case 36289:case 36303:case 36311:case 36292:return s_}}class o_{constructor(e,t,n){this.id=e,this.addr=n,this.cache=[],this.type=t.type,this.setValue=zg(t.type)}}class l_{constructor(e,t,n){this.id=e,this.addr=n,this.cache=[],this.type=t.type,this.size=t.size,this.setValue=a_(t.type)}}class c_{constructor(e){this.id=e,this.seq=[],this.map={}}setValue(e,t,n){const r=this.seq;for(let s=0,o=r.length;s!==o;++s){const a=r[s];a.setValue(e,t[a.id],n)}}}const ta=/(\w+)(\])?(\[|\.)?/g;function zl(i,e){i.seq.push(e),i.map[e.id]=e}function u_(i,e,t){const n=i.name,r=n.length;for(ta.lastIndex=0;;){const s=ta.exec(n),o=ta.lastIndex;let a=s[1];const l=s[2]==="]",c=s[3];if(l&&(a=a|0),c===void 0||c==="["&&o+2===r){zl(t,c===void 0?new o_(a,i,e):new l_(a,i,e));break}else{let h=t.map[a];h===void 0&&(h=new c_(a),zl(t,h)),t=h}}}class fr{constructor(e,t){this.seq=[],this.map={};const n=e.getProgramParameter(t,e.ACTIVE_UNIFORMS);for(let r=0;r<n;++r){const s=e.getActiveUniform(t,r),o=e.getUniformLocation(t,s.name);u_(s,o,this)}}setValue(e,t,n,r){const s=this.map[t];s!==void 0&&s.setValue(e,n,r)}setOptional(e,t,n){const r=t[n];r!==void 0&&this.setValue(e,n,r)}static upload(e,t,n,r){for(let s=0,o=t.length;s!==o;++s){const a=t[s],l=n[a.id];l.needsUpdate!==!1&&a.setValue(e,l.value,r)}}static seqWithValue(e,t){const n=[];for(let r=0,s=e.length;r!==s;++r){const o=e[r];o.id in t&&n.push(o)}return n}}function Vl(i,e,t){const n=i.createShader(e);return i.shaderSource(n,t),i.compileShader(n),n}const h_=37297;let d_=0;function f_(i,e){const t=i.split(`
`),n=[],r=Math.max(e-6,0),s=Math.min(e+6,t.length);for(let o=r;o<s;o++){const a=o+1;n.push(`${a===e?">":" "} ${a}: ${t[o]}`)}return n.join(`
`)}function p_(i){const e=je.getPrimaries(je.workingColorSpace),t=je.getPrimaries(i);let n;switch(e===t?n="":e===vr&&t===_r?n="LinearDisplayP3ToLinearSRGB":e===_r&&t===vr&&(n="LinearSRGBToLinearDisplayP3"),i){case vn:case wr:return[n,"LinearTransferOETF"];case Ft:case ba:return[n,"sRGBTransferOETF"];default:return console.warn("THREE.WebGLProgram: Unsupported color space:",i),[n,"LinearTransferOETF"]}}function Gl(i,e,t){const n=i.getShaderParameter(e,i.COMPILE_STATUS),r=i.getShaderInfoLog(e).trim();if(n&&r==="")return"";const s=/ERROR: 0:(\d+)/.exec(r);if(s){const o=parseInt(s[1]);return t.toUpperCase()+`

`+r+`

`+f_(i.getShaderSource(e),o)}else return r}function m_(i,e){const t=p_(e);return`vec4 ${i}( vec4 value ) { return ${t[0]}( ${t[1]}( value ) ); }`}function g_(i,e){let t;switch(e){case Md:t="Linear";break;case bd:t="Reinhard";break;case Ed:t="OptimizedCineon";break;case Td:t="ACESFilmic";break;case Ad:t="AgX";break;case Cd:t="Neutral";break;case wd:t="Custom";break;default:console.warn("THREE.WebGLProgram: Unsupported toneMapping:",e),t="Linear"}return"vec3 "+i+"( vec3 color ) { return "+t+"ToneMapping( color ); }"}function __(i){return[i.extensionClipCullDistance?"#extension GL_ANGLE_clip_cull_distance : require":"",i.extensionMultiDraw?"#extension GL_ANGLE_multi_draw : require":""].filter(Ti).join(`
`)}function v_(i){const e=[];for(const t in i){const n=i[t];n!==!1&&e.push("#define "+t+" "+n)}return e.join(`
`)}function x_(i,e){const t={},n=i.getProgramParameter(e,i.ACTIVE_ATTRIBUTES);for(let r=0;r<n;r++){const s=i.getActiveAttrib(e,r),o=s.name;let a=1;s.type===i.FLOAT_MAT2&&(a=2),s.type===i.FLOAT_MAT3&&(a=3),s.type===i.FLOAT_MAT4&&(a=4),t[o]={type:s.type,location:i.getAttribLocation(e,o),locationSize:a}}return t}function Ti(i){return i!==""}function Hl(i,e){const t=e.numSpotLightShadows+e.numSpotLightMaps-e.numSpotLightShadowsWithMaps;return i.replace(/NUM_DIR_LIGHTS/g,e.numDirLights).replace(/NUM_SPOT_LIGHTS/g,e.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,e.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,t).replace(/NUM_RECT_AREA_LIGHTS/g,e.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,e.numPointLights).replace(/NUM_HEMI_LIGHTS/g,e.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,e.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,e.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,e.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,e.numPointLightShadows)}function Wl(i,e){return i.replace(/NUM_CLIPPING_PLANES/g,e.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,e.numClippingPlanes-e.numClipIntersection)}const y_=/^[ \t]*#include +<([\w\d./]+)>/gm;function ma(i){return i.replace(y_,M_)}const S_=new Map;function M_(i,e){let t=ke[e];if(t===void 0){const n=S_.get(e);if(n!==void 0)t=ke[n],console.warn('THREE.WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',e,n);else throw new Error("Can not resolve #include <"+e+">")}return ma(t)}const b_=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function Xl(i){return i.replace(b_,E_)}function E_(i,e,t,n){let r="";for(let s=parseInt(e);s<parseInt(t);s++)r+=n.replace(/\[\s*i\s*\]/g,"[ "+s+" ]").replace(/UNROLLED_LOOP_INDEX/g,s);return r}function ql(i){let e=`precision ${i.precision} float;
...
#define LOW_PRECISION`),e}function T_(i){let e="SHADOWMAP_TYPE_BASIC";return i.shadowMapType===Dc?e="SHADOWMAP_TYPE_PCF":i.shadowMapType===jh?e="SHADOWMAP_TYPE_PCF_SOFT":i.shadowMapType===Kt&&(e="SHADOWMAP_TYPE_VSM"),e}function w_(i){let e="ENVMAP_TYPE_CUBE";if(i.envMap)switch(i.envMapMode){case ci:case ui:e="ENVMAP_TYPE_CUBE";break;case Er:e="ENVMAP_TYPE_CUBE_UV";break}return e}function A_(i){let e="ENVMAP_MODE_REFLECTION";if(i.envMap)switch(i.envMapMode){case ui:e="ENVMAP_MODE_REFRACTION";break}return e}function C_(i){let e="ENVMAP_BLENDING_NONE";if(i.envMap)switch(i.combine){case Ic:e="ENVMAP_BLENDING_MULTIPLY";break;case yd:e="ENVMAP_BLENDING_MIX";break;case Sd:e="ENVMAP_BLENDING_ADD";break}return e}function R_(i){const e=i.envMapCubeUVHeight;if(e===null)return null;const t=Math.log2(e)-2,n=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),7*16)),texelHeight:n,maxMip:t}}function P_(i,e,t,n){const r=i.getContext(),s=t.defines;let o=t.vertexShader,a=t.fragmentShader;const l=T_(t),c=w_(t),u=A_(t),h=C_(t),d=R_(t),f=__(t),g=v_(s),x=r.createProgram();let m,p,T=t.glslVersion?"#version "+t.glslVersion+`
...
`].filter(Ti).join(`
`)),o=ma(o),o=Hl(o,t),o=Wl(o,t),a=ma(a),a=Hl(a,t),a=Wl(a,t),o=Xl(o),a=Xl(a),t.isRawShaderMaterial!==!0&&(T=`#version 300 es
...
`)+`
`+p);const S=T+m+o,A=T+p+a,B=Vl(r,r.VERTEX_SHADER,S),D=Vl(r,r.FRAGMENT_SHADER,A);r.attachShader(x,B),r.attachShader(x,D),t.index0AttributeName!==void 0?r.bindAttribLocation(x,0,t.index0AttributeName):t.morphTargets===!0&&r.bindAttribLocation(x,0,"position"),r.linkProgram(x);function P(C){if(i.debug.checkShaderErrors){const H=r.getProgramInfoLog(x).trim(),O=r.getShaderInfoLog(B).trim(),$=r.getShaderInfoLog(D).trim();let z=!0,Y=!0;if(r.getProgramParameter(x,r.LINK_STATUS)===!1)if(z=!1,typeof i.debug.onShaderError=="function")i.debug.onShaderError(r,x,B,D);else{const te=Gl(r,B,"vertex"),v=Gl(r,D,"fragment");console.error("THREE.WebGLProgram: Shader Error "+r.getError()+" - VALIDATE_STATUS "+r.getProgramParameter(x,r.VALIDATE_STATUS)+`
