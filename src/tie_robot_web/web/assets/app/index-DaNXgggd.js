...
测试`,tone:"amber"}],hc={pauseResume:{id:"pauseResume",group:"末端控制",stateKey:"paused",initialValue:!1,inactiveLabel:"暂停作业",activeLabel:"恢复作业",inactiveTone:"amber",activeTone:"green",activateCommandId:10,deactivateCommandId:13},lashingEnabled:{id:"lashingEnabled",group:"末端控制",stateKey:"enabled",initialValue:!0,inactiveLabel:"开启绑扎",activeLabel:"关闭绑扎",inactiveTone:"green",activeTone:"red",activateCommandId:11,deactivateCommandId:16},jumpBindEnabled:{id:"jumpBindEnabled",group:"末端控制",stateKey:"enabled",initialValue:!1,inactiveLabel:"开启跳绑",activeLabel:"关闭跳绑",inactiveTone:"blue",activeTone:"amber",commandId:12,messageType:"std_msgs/Bool"},lightEnabled:{id:"lightEnabled",group:"末端控制",stateKey:"enabled",initialValue:!1,inactiveLabel:"开启灯光",activeLabel:"关闭灯光",inactiveTone:"blue",activeTone:"amber",commandId:14,messageType:"std_msgs/Bool"}},Mu=[{title:"流程控制",items:[1,2,3,4,5,17,20,23]},{title:"调试控制",items:[7,6,8,9]},{title:"末端控制",items:["pauseResume","lashingEnabled","jumpBindEnabled","lightEnabled",15,18,21,24]},{title:"视觉调试",items:[19,22]}],bu={1:"green",2:"green",3:"red",4:"green",5:"amber",6:"amber",7:"amber",8:"amber",9:"amber",15:"green",17:"red",18:"red",19:"blue",20:"blue",21:"blue",22:"blue",23:"blue",24:"blue"};function dc(i){return bu[i]||"amber"}function cn(i){return hc[i]||null}function fc(i){const e=cn(i);if(!e)return null;const t=!!e.initialValue;return{value:t,label:t?e.activeLabel:e.inactiveLabel,tone:t?e.activeTone:e.inactiveTone}}function hr(){return Object.keys(hc).reduce((i,e)=>(i[e]=fc(e),i),{})}function Eu(){return Mu.map(i=>({title:i.title,controls:i.items.map(e=>{if(typeof e=="string"){const n=cn(e);if(!n)return null;const r=fc(e);return{kind:"toggle",id:n.id,label:(r==null?void 0:r.label)||n.inactiveLabel,tone:(r==null?void 0:r.tone)||n.inactiveTone,active:!!(r!=null&&r.value)}}const t=ca.find(n=>n.id===e);return t?{kind:"command",id:String(t.id),commandId:t.id,label:t.name,tone:dc(t.id)}:null}).filter(Boolean)}))}var pc=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};function Tu(i){return i&&i.__esModule&&Object.prototype.hasOwnProperty.call(i,"default")?i.default:i}/*
object-assign
(c) Sindre Sorhus
@license MIT
