...
您可以参考[Scepter 图形化工具介绍](/camera-sdk/vendor-vzense/zh-cn/ScepterGUITool/Overview.md)了解相机的详细功能，开始探索相机。
...
您可以参考[Scepter 软件开发包介绍](/camera-sdk/vendor-vzense/zh-cn/ScepterSDK/Overview.md)了解相机的详细功能，开始探索相机。
