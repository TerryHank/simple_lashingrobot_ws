...
#### 对齐后的 Depth 图像
![DepthImgToColorSensorImage](FunctionIntroduction-asserts/27.png)

#### Color 图像
![ColorImage](FunctionIntroduction-asserts/28.png)
...
#### Depth 图像
![DepthImage](FunctionIntroduction-asserts/31.png)

#### 对齐后的 Color 图像
![ColorImgToDepthSensorImage](FunctionIntroduction-asserts/32.png)
...
#### IR 图像
![IRImage](FunctionIntroduction-asserts/35.png)
...
#### Black BG 关闭
![Black BG close](FunctionIntroduction-asserts/62.png)

#### Black BG 开启
![Black BG open](FunctionIntroduction-asserts/63.png)
...
#### Spatial Filter 关闭
![Spatial Filter close](FunctionIntroduction-asserts/64.png)

#### Spatial Filter 开启
![Spatial Filter open](FunctionIntroduction-asserts/65.png)
...
#### Flying Pixel Filter 关闭
![Flying Pixel Filter close](FunctionIntroduction-asserts/70.png)

#### Flying Pixel Filter 值为 15
![Flying Pixel Filter value: 15](FunctionIntroduction-asserts/71.png)
...
#### Confidence Filter 值为 15
![Confidence Filter value 15](FunctionIntroduction-asserts/74.png)

#### Confidence Filter 值为 50
![Confidence Filter value 50](FunctionIntroduction-asserts/75.png)
...
#### 曝光时间 58us
![Exposure58](FunctionIntroduction-asserts/76.png)

#### 曝光时间 1000us
![Exposure1000](FunctionIntroduction-asserts/77.png)

#### HDR 模式
![HDR](FunctionIntroduction-asserts/78.png)
...
#### 近处 0-4.5m
![Exposure58](FunctionIntroduction-asserts/3-4-3-4-04.png)

#### 远处 3.5-8m
![Exposure1000](FunctionIntroduction-asserts/3-4-3-4-05.png)

#### WDR 模式
![WDR](FunctionIntroduction-asserts/3-4-3-4-06.png)
...
#### Gamma Gain 值 25
![GammaGain25](FunctionIntroduction-asserts/81.png)

#### Gamma Gain 值 100
![GammaGain100](FunctionIntroduction-asserts/82.png)
...
#### Gamma Correction 关闭
![GammaCorrectionOff](FunctionIntroduction-asserts/82.png)

#### Gamma Correction 值 50
![GammaCorrection50](FunctionIntroduction-asserts/83.png)

#### Gamma Correction 值 100
![GammaCorrection100](FunctionIntroduction-asserts/84.png)
