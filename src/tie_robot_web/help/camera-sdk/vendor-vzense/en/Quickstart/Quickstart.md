...
You can refer to [ScepterGUITool introduction](/camera-sdk/vendor-vzense/en/ScepterGUITool/Overview.md) to learn about the detailed functions of the camera and start exploring the camera.
...
You can refer to [ScepterSDK introduction](/camera-sdk/vendor-vzense/en/ScepterSDK/Overview.md) to learn about the detailed functions of the camera and start exploring the camera.
