...
class TieRobotArchitectureCleanupTest(unittest.TestCase):
    ...
    def test_driver_nodes_publish_standard_diagnostics_and_support_independent_start_stop(self):
        ...
        self.assertIn('chassis: level === "success" ? "stopCabinSubsystem" : level === "error" ? "restartCabinSubsystem" : "startCabinSubsystem"', web_ui)
        self.assertIn('moduan: level === "success" ? "stopModuanSubsystem" : level === "error" ? "restartModuanSubsystem" : "startModuanSubsystem"', web_ui)
